# Autback contributor guide

Autback is a shared remote execution service for a small, trusted engineering team.
...
wire route is a protocol compatibility boundary, not a product alias.
