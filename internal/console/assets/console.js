var F=globalThis,U=F.ShadowRoot&&(F.ShadyCSS===void 0||F.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,B=Symbol(),te=new WeakMap;class L{constructor(e,a,t){if(this._$cssResult$=!0,t!==B)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=a}get styleSheet(){let e=this.o,a=this.t;if(U&&e===void 0){let t=a!==void 0&&a.length===1;t&&(e=te.get(a)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),t&&te.set(a,e))}return e}toString(){return this.cssText}}var re=(e)=>new L(typeof e=="string"?e:e+"",void 0,B),G=(e,...a)=>{let t=e.length===1?e[0]:a.reduce((r,i,o)=>r+((n)=>{if(n._$cssResult$===!0)return n.cssText;if(typeof n=="number")return n;throw Error("Value passed to 'css' function must be a 'css' function result: "+n+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+e[o+1],e[0]);return new L(t,e,B)},ie=(e,a)=>{if(U)e.adoptedStyleSheets=a.map((t)=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let t of a){let r=document.createElement("style"),i=F.litNonce;i!==void 0&&r.setAttribute("nonce",i),r.textContent=t.cssText,e.appendChild(r)}},Y=U?(e)=>e:(e)=>e instanceof CSSStyleSheet?((a)=>{let t="";for(let r of a.cssRules)t+=r.cssText;return re(t)})(e):e;var{is:Me,defineProperty:Ie,getOwnPropertyDescriptor:Se,getOwnPropertyNames:Ae,getOwnPropertySymbols:Oe,getPrototypeOf:Ve}=Object,K=globalThis,ne=K.trustedTypes,Ne=ne?ne.emptyScript:"",Fe=K.reactiveElementPolyfillSupport,z=(e,a)=>e,H={toAttribute(e,a){switch(a){case Boolean:e=e?Ne:null;break;case Object:case Array:e=e==null?e:JSON.stringify(e)}return e},fromAttribute(e,a){let t=e;switch(a){case Boolean:t=e!==null;break;case Number:t=e===null?null:Number(e);break;case Object:case Array:try{t=JSON.parse(e)}catch(r){t=null}}return t}},se=(e,a)=>!Me(e,a),oe={attribute:!0,type:String,converter:H,reflect:!1,useDefault:!1,hasChanged:se};Symbol.metadata??=Symbol("metadata"),K.litPropertyMetadata??=new WeakMap;class v extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,a=oe){if(a.state&&(a.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((a=Object.create(a)).wrapped=!0),this.elementProperties.set(e,a),!a.noAccessor){let t=Symbol(),r=this.getPropertyDescriptor(e,t,a);r!==void 0&&Ie(this.prototype,e,r)}}static getPropertyDescriptor(e,a,t){let{get:r,set:i}=Se(this.prototype,e)??{get(){return this[a]},set(o){this[a]=o}};return{get:r,set(o){let n=r?.call(this);i?.call(this,o),this.requestUpdate(e,n,t)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??oe}static _$Ei(){if(this.hasOwnProperty(z("elementProperties")))return;let e=Ve(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(z("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(z("properties"))){let a=this.properties,t=[...Ae(a),...Oe(a)];for(let r of t)this.createProperty(r,a[r])}let e=this[Symbol.metadata];if(e!==null){let a=litPropertyMetadata.get(e);if(a!==void 0)for(let[t,r]of a)this.elementProperties.set(t,r)}this._$Eh=new Map;for(let[a,t]of this.elementProperties){let r=this._$Eu(a,t);r!==void 0&&this._$Eh.set(r,a)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){let a=[];if(Array.isArray(e)){let t=new Set(e.flat(1/0).reverse());for(let r of t)a.unshift(Y(r))}else e!==void 0&&a.push(Y(e));return a}static _$Eu(e,a){let t=a.attribute;return t===!1?void 0:typeof t=="string"?t:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise((e)=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach((e)=>e(this))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){let e=new Map,a=this.constructor.elementProperties;for(let t of a.keys())this.hasOwnProperty(t)&&(e.set(t,this[t]),delete this[t]);e.size>0&&(this._$Ep=e)}createRenderRoot(){let e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return ie(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach((e)=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach((e)=>e.hostDisconnected?.())}attributeChangedCallback(e,a,t){this._$AK(e,t)}_$ET(e,a){let t=this.constructor.elementProperties.get(e),r=this.constructor._$Eu(e,t);if(r!==void 0&&t.reflect===!0){let i=(t.converter?.toAttribute!==void 0?t.converter:H).toAttribute(a,t.type);this._$Em=e,i==null?this.removeAttribute(r):this.setAttribute(r,i),this._$Em=null}}_$AK(e,a){let t=this.constructor,r=t._$Eh.get(e);if(r!==void 0&&this._$Em!==r){let i=t.getPropertyOptions(r),o=typeof i.converter=="function"?{fromAttribute:i.converter}:i.converter?.fromAttribute!==void 0?i.converter:H;this._$Em=r;let n=o.fromAttribute(a,i.type);this[r]=n??this._$Ej?.get(r)??n,this._$Em=null}}requestUpdate(e,a,t,r=!1,i){if(e!==void 0){let o=this.constructor;if(r===!1&&(i=this[e]),t??=o.getPropertyOptions(e),!((t.hasChanged??se)(i,a)||t.useDefault&&t.reflect&&i===this._$Ej?.get(e)&&!this.hasAttribute(o._$Eu(e,t))))return;this.C(e,a,t)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,a,{useDefault:t,reflect:r,wrapped:i},o){t&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,o??a??this[e]),i!==!0||o!==void 0)||(this._$AL.has(e)||(this.hasUpdated||t||(a=void 0),this._$AL.set(e,a)),r===!0&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(a){Promise.reject(a)}let e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[r,i]of this._$Ep)this[r]=i;this._$Ep=void 0}let t=this.constructor.elementProperties;if(t.size>0)for(let[r,i]of t){let{wrapped:o}=i,n=this[r];o!==!0||this._$AL.has(r)||n===void 0||this.C(r,void 0,i,n)}}let e=!1,a=this._$AL;try{e=this.shouldUpdate(a),e?(this.willUpdate(a),this._$EO?.forEach((t)=>t.hostUpdate?.()),this.update(a)):this._$EM()}catch(t){throw e=!1,this._$EM(),t}e&&this._$AE(a)}willUpdate(e){}_$AE(e){this._$EO?.forEach((a)=>a.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&=this._$Eq.forEach((a)=>this._$ET(a,this[a])),this._$EM()}updated(e){}firstUpdated(e){}}v.elementStyles=[],v.shadowRootOptions={mode:"open"},v[z("elementProperties")]=new Map,v[z("finalized")]=new Map,Fe?.({ReactiveElement:v}),(K.reactiveElementVersions??=[]).push("2.1.2");var Q=globalThis,le=(e)=>e,E=Q.trustedTypes,de=E?E.createPolicy("lit-html",{createHTML:(e)=>e}):void 0;var f=`lit$${Math.random().toFixed(9).slice(2)}$`,xe="?"+f,Ue=`<${xe}>`,j=document,D=()=>j.createComment(""),M=(e)=>e===null||typeof e!="object"&&typeof e!="function",J=Array.isArray,Le=(e)=>J(e)||typeof e?.[Symbol.iterator]=="function";var q=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,pe=/-->/g,ce=/>/g,y=RegExp(`>|[ 	
\f\r](?:([^\\s"'>=/]+)([ 	
\f\r]*=[ 	
\f\r]*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),ue=/'/g,ge=/"/g,he=/^(?:script|style|textarea|title)$/i,X=(e)=>(a,...t)=>({_$litType$:e,strings:a,values:t}),d=X(1),g=X(2),_e=X(3),R=Symbol.for("lit-noChange"),c=Symbol.for("lit-nothing"),me=new WeakMap,k=j.createTreeWalker(j,129);function ve(e,a){if(!J(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return de!==void 0?de.createHTML(a):a}var Ke=(e,a)=>{let t=e.length-1,r=[],i,o=a===2?"<svg>":a===3?"<math>":"",n=q;for(let s=0;s<t;s++){let p=e[s],N,l,m=-1,x=0;for(;x<p.length&&(n.lastIndex=x,l=n.exec(p),l!==null);)x=n.lastIndex,n===q?l[1]==="!--"?n=pe:l[1]!==void 0?n=ce:l[2]!==void 0?(he.test(l[2])&&(i=RegExp("</"+l[2],"g")),n=y):l[3]!==void 0&&(n=y):n===y?l[0]===">"?(n=i??q,m=-1):l[1]===void 0?m=-2:(m=n.lastIndex-l[2].length,N=l[1],n=l[3]===void 0?y:l[3]==='"'?ge:ue):n===ge||n===ue?n=y:n===pe||n===ce?n=q:(n=y,i=void 0);let $=n===y&&e[s+1].startsWith("/>")?" ":"";o+=n===q?p+Ue:m>=0?(r.push(N),p.slice(0,m)+"$lit$"+p.slice(m)+f+$):p+f+(m===-2?s:$)}return[ve(e,o+(e[t]||"<?>")+(a===2?"</svg>":a===3?"</math>":"")),r]};class I{constructor({strings:e,_$litType$:a},t){let r;this.parts=[];let i=0,o=0,n=e.length-1,s=this.parts,[p,N]=Ke(e,a);if(this.el=I.createElement(p,t),k.currentNode=this.el.content,a===2||a===3){let l=this.el.content.firstChild;l.replaceWith(...l.childNodes)}for(;(r=k.nextNode())!==null&&s.length<n;){if(r.nodeType===1){if(r.hasAttributes())for(let l of r.getAttributeNames())if(l.endsWith("$lit$")){let m=N[o++],x=r.getAttribute(l).split(f),$=/([.?@])?(.*)/.exec(m);s.push({type:1,index:i,name:$[2],strings:x,ctor:$[1]==="."?be:$[1]==="?"?we:$[1]==="@"?$e:A}),r.removeAttribute(l)}else l.startsWith(f)&&(s.push({type:6,index:i}),r.removeAttribute(l));if(he.test(r.tagName)){let l=r.textContent.split(f),m=l.length-1;if(m>0){r.textContent=E?E.emptyScript:"";for(let x=0;x<m;x++)r.append(l[x],D()),k.nextNode(),s.push({type:2,index:++i});r.append(l[m],D())}}}else if(r.nodeType===8)if(r.data===xe)s.push({type:2,index:i});else{let l=-1;for(;(l=r.data.indexOf(f,l+1))!==-1;)s.push({type:7,index:i}),l+=f.length-1}i++}}static createElement(e,a){let t=j.createElement("template");return t.innerHTML=e,t}}function T(e,a,t=e,r){if(a===R)return a;let i=r!==void 0?t._$Co?.[r]:t._$Cl,o=M(a)?void 0:a._$litDirective$;return i?.constructor!==o&&(i?._$AO?.(!1),o===void 0?i=void 0:(i=new o(e),i._$AT(e,t,r)),r!==void 0?(t._$Co??=[])[r]=i:t._$Cl=i),i!==void 0&&(a=T(e,i._$AS(e,a.values),i,r)),a}class fe{constructor(e,a){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=a}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:a},parts:t}=this._$AD,r=(e?.creationScope??j).importNode(a,!0);k.currentNode=r;let i=k.nextNode(),o=0,n=0,s=t[0];for(;s!==void 0;){if(o===s.index){let p;s.type===2?p=new S(i,i.nextSibling,this,e):s.type===1?p=new s.ctor(i,s.name,s.strings,this,e):s.type===6&&(p=new ye(i,this,e)),this._$AV.push(p),s=t[++n]}o!==s?.index&&(i=k.nextNode(),o++)}return k.currentNode=j,r}p(e){let a=0;for(let t of this._$AV)t!==void 0&&(t.strings!==void 0?(t._$AI(e,t,a),a+=t.strings.length-2):t._$AI(e[a])),a++}}class S{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,a,t,r){this.type=2,this._$AH=c,this._$AN=void 0,this._$AA=e,this._$AB=a,this._$AM=t,this.options=r,this._$Cv=r?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,a=this._$AM;return a!==void 0&&e?.nodeType===11&&(e=a.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,a=this){e=T(this,e,a),M(e)?e===c||e==null||e===""?(this._$AH!==c&&this._$AR(),this._$AH=c):e!==this._$AH&&e!==R&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):Le(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==c&&M(this._$AH)?this._$AA.nextSibling.data=e:this.T(j.createTextNode(e)),this._$AH=e}$(e){let{values:a,_$litType$:t}=e,r=typeof t=="number"?this._$AC(e):(t.el===void 0&&(t.el=I.createElement(ve(t.h,t.h[0]),this.options)),t);if(this._$AH?._$AD===r)this._$AH.p(a);else{let i=new fe(r,this),o=i.u(this.options);i.p(a),this.T(o),this._$AH=i}}_$AC(e){let a=me.get(e.strings);return a===void 0&&me.set(e.strings,a=new I(e)),a}k(e){J(this._$AH)||(this._$AH=[],this._$AR());let a=this._$AH,t,r=0;for(let i of e)r===a.length?a.push(t=new S(this.O(D()),this.O(D()),this,this.options)):t=a[r],t._$AI(i),r++;r<a.length&&(this._$AR(t&&t._$AB.nextSibling,r),a.length=r)}_$AR(e=this._$AA.nextSibling,a){for(this._$AP?.(!1,!0,a);e!==this._$AB;){let t=le(e).nextSibling;le(e).remove(),e=t}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}}class A{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,a,t,r,i){this.type=1,this._$AH=c,this._$AN=void 0,this.element=e,this.name=a,this._$AM=r,this.options=i,t.length>2||t[0]!==""||t[1]!==""?(this._$AH=Array(t.length-1).fill(new String),this.strings=t):this._$AH=c}_$AI(e,a=this,t,r){let i=this.strings,o=!1;if(i===void 0)e=T(this,e,a,0),o=!M(e)||e!==this._$AH&&e!==R,o&&(this._$AH=e);else{let n=e,s,p;for(e=i[0],s=0;s<i.length-1;s++)p=T(this,n[t+s],a,s),p===R&&(p=this._$AH[s]),o||=!M(p)||p!==this._$AH[s],p===c?e=c:e!==c&&(e+=(p??"")+i[s+1]),this._$AH[s]=p}o&&!r&&this.j(e)}j(e){e===c?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class be extends A{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===c?void 0:e}}class we extends A{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==c)}}class $e extends A{constructor(e,a,t,r,i){super(e,a,t,r,i),this.type=5}_$AI(e,a=this){if((e=T(this,e,a,0)??c)===R)return;let t=this._$AH,r=e===c&&t!==c||e.capture!==t.capture||e.once!==t.once||e.passive!==t.passive,i=e!==c&&(t===c||r);r&&this.element.removeEventListener(this.name,this,t),i&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}}class ye{constructor(e,a,t){this.element=e,this.type=6,this._$AN=void 0,this._$AM=a,this.options=t}get _$AU(){return this._$AM._$AU}_$AI(e){T(this,e)}}var Ee=Q.litHtmlPolyfillSupport;Ee?.(I,S),(Q.litHtmlVersions??=[]).push("3.3.3");var ke=(e,a,t)=>{let r=t?.renderBefore??a,i=r._$litPart$;if(i===void 0){let o=t?.renderBefore??null;r._$litPart$=i=new S(a.insertBefore(D(),o),o,void 0,t??{})}return i._$AI(e),i};var Z=globalThis;class C extends v{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let a=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=ke(a,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return R}}C._$litElement$=!0,C.finalized=!0,Z.litElementHydrateSupport?.({LitElement:C});var We=Z.litElementPolyfillSupport;We?.({LitElement:C});(Z.litElementVersions??=[]).push("4.2.2");var je=null;function Re(){let e=new URL("/app/assets/datastar.js",window.location.href).href;return je??=import(e),je}var P=null,Ce=null;function Te(e){class a extends e{#e=null;#a=!1;connectedCallback(){this.#a=!0,super.connectedCallback(),Be().then(async()=>{if(!this.#a)return;if(this.requestUpdate(),await this.updateComplete,await Ge(),this.#a)this.requestUpdate()})}performUpdate(){if(!this.isUpdatePending)return;let t=P;if(!t){super.performUpdate();return}this.#e?.();let r=!0;this.#e=t.effect(()=>{if(Object.keys(t.root),r){r=!1,super.performUpdate();return}this.requestUpdate()})}disconnectedCallback(){this.#a=!1,this.#e?.(),this.#e=null,super.disconnectedCallback()}signal(t,r){let i=P?.getPath(t);return _(i===void 0?r:i)}}return a}async function Be(){if(P)return P;return Ce??=Re(),P=await Ce,P}async function Ge(){await Promise.resolve(),await new Promise((e)=>requestAnimationFrame(()=>e()))}function _(e){if(Array.isArray(e))return e.map((a)=>_(a));if(e&&typeof e==="object")return Object.fromEntries(Object.entries(e).map(([a,t])=>[a,_(t)]));return e}var Pe=G`
  :host {
    color-scheme: dark;
    --canvas: #0b0b0d;
    --canvas-soft: #101013;
...
`;function b(e,a=12){if(e.length<=a)return e;return`${e.slice(0,a-1)}…`}function ee(e){if(!e)return"Not configured";let a=e.includes("@")?e.split("@").at(-1):e;return a.length>23?`${a.slice(0,16)}…${a.slice(-6)}`:a}function O(e,a=Date.now()){let t=Date.parse(e);if(!Number.isFinite(t))return"—";let r=Math.max(0,Math.round((a-t)/1000));if(r<5)return"now";if(r<60)return`${r}s ago`;let i=Math.floor(r/60);if(i<60)return`${i}m ago`;let o=Math.floor(i/60);if(o<24)return`${o}h ago`;return`${Math.floor(o/24)}d ago`}function ae(e,a,t=Date.now()){if(!e)return"—";let r=Date.parse(e),i=a?Date.parse(a):t;if(!Number.isFinite(r)||!Number.isFinite(i)||i<r)return"—";let o=i-r;if(o<1000)return`${o}ms`;let n=o/1000;if(n<60)return`${n.toFixed(n<10?1:0)}s`;return`${Math.floor(n/60)}m ${Math.floor(n%60)}s`}function ze(e){let a=e.filter((r)=>["succeeded","success","failed","cancelled"].includes(r));if(a.length===0)return"—";let t=a.filter((r)=>r==="succeeded"||r==="success").length;return`${Math.round(t/a.length*100)}%`}var h={session:{user:"",admin:!1,projects:[]},service:{name:"Autback",version:"",control:"CLI only",admission:"Strict FIFO",startedAt:""},worker:{status:"connecting",capacity:"1 operation",activeId:"",updatedAt:""},queue:[],operations:[],operation:null,log:{available:!1,truncated:!1,content:""},audit:[],status:{ready:!1,route:"",message:"Connecting",updatedAt:""}};class De extends Te(C){static styles=Pe;get routeKind(){return this.getAttribute("route-kind")||"overview"}get project(){return this.getAttribute("project")||""}get operationKind(){return this.getAttribute("operation-kind")||""}get operationID(){return this.getAttribute("operation-id")||""}render(){let e=this.signals();return d`
      <div class="shell">
        ${this.sidebar(e)}
    ...
    `}signals(){return{session:this.signal("session",h.session),service:this.signal("service",h.service),worker:this.signal("worker",h.worker),queue:this.signal("queue",h.queue),operations:this.signal("operations",h.operations),operation:this.signal("operation",h.operation),log:this.signal("log",h.log),audit:this.signal("audit",h.audit),status:this.signal("status",h.status)}}sidebar(e){return d`
    ...
    `}page(e){switch(this.routeKind){case"project":return this.projectPage(e);case"operation":return this.operationPage(e);case"audit":return this.auditPage(e);default:return this.overview(e)}}overview(e){let a=e.operations.filter((r)=>["running","active","preparing"].includes(r.status)).length,t=e.queue.filter((r)=>r.status==="queued").length;return d`
      ...
      <section class="metrics" aria-label="Service metrics">
        ${w("Runner",e.worker.status,e.worker.capacity,"cpu")}
        ${w("Active",String(a),a===1?"operation running now":"operations running now","pulse")}
        ${w("Waiting",String(t),t===1?"operation next in line":"operations in line","queue")}
        ${w("Success",ze(e.operations.map((r)=>r.status)),"completed operations","trend")}
      </section>
      <section class="grid">
        ${this.queuePanel(e.queue)}
        <article class="panel">
          <header class="panel-head"><div class="panel-title">${u("cpu")}Runner</div><span class="badge ${e.worker.status}">${e.worker.status}</span></header>
          <div class="worker-orbit">
            <div class="worker-core">${u("cpu")}</div>
            <div class="worker-label"><strong>${e.worker.activeId?b(e.worker.activeId,16):"Available"}</strong><span>${e.worker.activeId?"current operation":"ready for the next operation"}</span></div>
          </div>
        </article>
      </section>
      ${this.operationsPanel(e.operations,"Recent operations")}
    `}projectPage(e){let a=e.session.projects.find((t)=>t.slug===this.project);if(!a)return this.notFound("You do not have access to this project.");return d`
      ${this.pageHead("Project",a.name,"Image policy, access, queue position, and recent operations.")}
      ...
      <section class="grid">
        ${this.queuePanel(e.queue)}
        <article class="panel">
          <header class="panel-head"><div class="panel-title">${u("terminal")}Manage project</div><span class="panel-meta">CLI</span></header>
          <div class="panel-body"><p class="lede">Use the Autback CLI to inspect or update project settings.</p><pre class="command"><span class="prompt">$</span> autback image show --project ${a.slug}</pre></div>
        </article>
      </section>
      ${this.operationsPanel(e.operations,"Project operations")}
    `}operationPage(e){let a=e.operation;if(!a)return this.notFound("You do not have access to this operation.");let t=a.command||`${W(a.kind)} ${b(a.id,18)}`;return d`
      ${this.pageHead(`${W(a.kind)} operation`,t,`${a.projectName} · ${b(a.id,26)}`)}
      <section class="metrics" aria-label="Operation metrics">
        ${w("Status",a.status,a.kind,"pulse")}
        ${w("Duration",ae(a.startedAt,a.finishedAt),a.startedAt?"elapsed time":"not started","clock")}
        ${w("Exit code",a.exitCode==null?"—":String(a.exitCode),a.finishedAt?"command result":"pending","terminal")}
        ${w("Created",O(a.createdAt),a.projectName,"calendar")}
      </section>
      <section class="detail-grid">
        ...
        <div class="detail-stack">
          ...
          <article class="panel">
            <header class="panel-head"><div class="panel-title">${u("terminal")}Continue in CLI</div><span class="panel-meta">CLI</span></header>
            <div class="panel-body"><p class="lede">View the full log or inspect this operation from your terminal.</p><pre class="command"><span class="prompt">$</span> autback ${a.kind==="job"?"logs":"build status"} ${a.id}</pre></div>
          </article>
        </div>
      </section>
    `}auditPage(e){return d`
      ...
      <article class="panel">
        ...
        ${e.audit.length===0?V("shield","No audit events yet","Changes made with the Autback CLI will appear here."):this.auditTable(e.audit)}
      </article>
    `}pageHead(e,a,t){return d`
      <header class="page-head">
        <div><p class="eyebrow">${e}</p><h1>${a}</h1><p class="lede">${t}</p></div>
        <div class="read-only">${u("eye")}CLI-managed</div>
      </header>
    `}queuePanel(e){return d`
      <article class="panel">
        ...
        <div class="queue-list">
          ${e.length===0?V("queue","The queue is clear","The next submitted operation starts immediately."):e.map((a)=>d`
            <div class="queue-row">
              <span class="position">${a.position}</span>
              <div class="queue-main"><a href=${qe(a.kind,a.id)}>${a.id}</a><div class="queue-sub">${a.projectName} · ${O(a.acceptedAt)}</div></div>
    ...
    `}operationsPanel(e,a){return d`
      <article class="panel">
        ...
        ${e.length===0?V("activity","No operations yet","Submit a repository command with autback exec."):d`
          <div class="table-wrap"><table>
            <thead><tr><th>Operation</th><th>Status</th><th>Project</th><th>Duration</th><th>Created</th></tr></thead>
            <tbody>${e.map((t)=>d`<tr>
              <td class="primary"><a href=${qe(t.kind,t.id)}><span class="kind-icon">${u(t.kind==="build"?"cube":"terminal")}</span><span><span class="mono">${b(t.id,20)}</span><br><span class="muted">${t.command||W(t.kind)}</span></span></a></td>
    ...
    `}logPanel(e,a){return d`
      <article class="panel">
        <header class="panel-head"><div class="panel-title">${u("terminal")}Output</div><span class="panel-meta">${e.log.available?"Live":"Unavailable"}</span></header>
        ${e.log.available?d`<pre class="log">${e.log.content||"Waiting for output…"}</pre>${e.log.truncated?d`<div class="log-note">Showing the latest output. Use <span class="mono">autback logs ${a.id}</span> for the full log.</div>`:c}`:V("terminal","No output available",a.kind==="build"?"Build progress remains in the invoking terminal.":"The runner has not produced output yet.")}
      </article>
    `}provenancePanel(e){let a=e.caches?.length?e.caches.map((t)=>t.name).join(", "):"None declared";return d`
      <article class="panel">
        <header class="panel-head"><div class="panel-title">${u("fingerprint")}Provenance</div><span class="panel-meta">Execution inputs</span></header>
        <dl class="definition">
