var W1=globalThis,Y1=W1.ShadowRoot&&(W1.ShadyCSS===void 0||W1.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,I1=Symbol(),Z0=new WeakMap;class J1{constructor(x,d,h){if(this._$cssResult$=!0,h!==I1)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=x,this.t=d}get styleSheet(){let x=this.o,d=this.t;if(Y1&&x===void 0){let h=d!==void 0&&d.length===1;h&&(x=Z0.get(d)),x===void 0&&((this.o=x=new CSSStyleSheet).replaceSync(this.cssText),h&&Z0.set(d,x))}return x}toString(){return this.cssText}}var K0=(x)=>new J1(typeof x=="string"?x:x+"",void 0,I1),d1=(x,...d)=>{let h=x.length===1?x[0]:d.reduce((p,i,v)=>p+((r)=>{if(r._$cssResult$===!0)return r.cssText;if(typeof r=="number")return r;throw Error("Value passed to 'css' function must be a 'css' function result: "+r+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+x[v+1],x[0]);return new J1(h,x,I1)},g0=(x,d)=>{if(Y1)x.adoptedStyleSheets=d.map((h)=>h instanceof CSSStyleSheet?h:h.styleSheet);else for(let h of d){let p=document.createElement("style"),i=W1.litNonce;i!==void 0&&p.setAttribute("nonce",i),p.textContent=h.cssText,x.appendChild(p)}},C1=Y1?(x)=>x:(x)=>x instanceof CSSStyleSheet?((d)=>{let h="";for(let p of d.cssRules)h+=p.cssText;return K0(h)})(x):x;var{is:cd,defineProperty:Gd,getOwnPropertyDescriptor:Dd,getOwnPropertyNames:Hd,getOwnPropertySymbols:Od,getPrototypeOf:fd}=Object,E1=globalThis,B0=E1.trustedTypes,Vd=B0?B0.emptyScript:"",Pd=E1.reactiveElementPolyfillSupport,h1=(x,d)=>x,R1={toAttribute(x,d){switch(d){case Boolean:x=x?Vd:null;break;case Object:case Array:x=x==null?x:JSON.stringify(x)}return x},fromAttribute(x,d){let h=x;switch(d){case Boolean:h=x!==null;break;case Number:h=x===null?null:Number(x);break;case Object:case Array:try{h=JSON.parse(x)}catch(p){h=null}}return h}},n0=(x,d)=>!cd(x,d),U0={attribute:!0,type:String,converter:R1,reflect:!1,useDefault:!1,hasChanged:n0};Symbol.metadata??=Symbol("metadata"),E1.litPropertyMetadata??=new WeakMap;class I extends HTMLElement{static addInitializer(x){this._$Ei(),(this.l??=[]).push(x)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(x,d=U0){if(d.state&&(d.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(x)&&((d=Object.create(d)).wrapped=!0),this.elementProperties.set(x,d),!d.noAccessor){let h=Symbol(),p=this.getPropertyDescriptor(x,h,d);p!==void 0&&Gd(this.prototype,x,p)}}static getPropertyDescriptor(x,d,h){let{get:p,set:i}=Dd(this.prototype,x)??{get(){return this[d]},set(v){this[d]=v}};return{get:p,set(v){let r=p?.call(this);i?.call(this,v),this.requestUpdate(x,r,h)},configurable:!0,enumerable:!0}}static getPropertyOptions(x){return this.elementProperties.get(x)??U0}static _$Ei(){if(this.hasOwnProperty(h1("elementProperties")))return;let x=fd(this);x.finalize(),x.l!==void 0&&(this.l=[...x.l]),this.elementProperties=new Map(x.elementProperties)}static finalize(){if(this.hasOwnProperty(h1("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(h1("properties"))){let d=this.properties,h=[...Hd(d),...Od(d)];for(let p of h)this.createProperty(p,d[p])}let x=this[Symbol.metadata];if(x!==null){let d=litPropertyMetadata.get(x);if(d!==void 0)for(let[h,p]of d)this.elementProperties.set(h,p)}this._$Eh=new Map;for(let[d,h]of this.elementProperties){let p=this._$Eu(d,h);p!==void 0&&this._$Eh.set(p,d)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(x){let d=[];if(Array.isArray(x)){let h=new Set(x.flat(1/0).reverse());for(let p of h)d.unshift(C1(p))}else x!==void 0&&d.push(C1(x));return d}static _$Eu(x,d){let h=d.attribute;return h===!1?void 0:typeof h=="string"?h:typeof x=="string"?x.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise((x)=>this.enableUpdating=x),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach((x)=>x(this))}addController(x){(this._$EO??=new Set).add(x),this.renderRoot!==void 0&&this.isConnected&&x.hostConnected?.()}removeController(x){this._$EO?.delete(x)}_$E_(){let x=new Map,d=this.constructor.elementProperties;for(let h of d.keys())this.hasOwnProperty(h)&&(x.set(h,this[h]),delete this[h]);x.size>0&&(this._$Ep=x)}createRenderRoot(){let x=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return g0(x,this.constructor.elementStyles),x}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach((x)=>x.hostConnected?.())}enableUpdating(x){}disconnectedCallback(){this._$EO?.forEach((x)=>x.hostDisconnected?.())}attributeChangedCallback(x,d,h){this._$AK(x,h)}_$ET(x,d){let h=this.constructor.elementProperties.get(x),p=this.constructor._$Eu(x,h);if(p!==void 0&&h.reflect===!0){let i=(h.converter?.toAttribute!==void 0?h.converter:R1).toAttribute(d,h.type);this._$Em=x,i==null?this.removeAttribute(p):this.setAttribute(p,i),this._$Em=null}}_$AK(x,d){let h=this.constructor,p=h._$Eh.get(x);if(p!==void 0&&this._$Em!==p){let i=h.getPropertyOptions(p),v=typeof i.converter=="function"?{fromAttribute:i.converter}:i.converter?.fromAttribute!==void 0?i.converter:R1;this._$Em=p;let r=v.fromAttribute(d,i.type);this[p]=r??this._$Ej?.get(p)??r,this._$Em=null}}requestUpdate(x,d,h,p=!1,i){if(x!==void 0){let v=this.constructor;if(p===!1&&(i=this[x]),h??=v.getPropertyOptions(x),!((h.hasChanged??n0)(i,d)||h.useDefault&&h.reflect&&i===this._$Ej?.get(x)&&!this.hasAttribute(v._$Eu(x,h))))return;this.C(x,d,h)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(x,d,{useDefault:h,reflect:p,wrapped:i},v){h&&!(this._$Ej??=new Map).has(x)&&(this._$Ej.set(x,v??d??this[x]),i!==!0||v!==void 0)||(this._$AL.has(x)||(this.hasUpdated||h||(d=void 0),this._$AL.set(x,d)),p===!0&&this._$Em!==x&&(this._$Eq??=new Set).add(x))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(d){Promise.reject(d)}let x=this.scheduleUpdate();return x!=null&&await x,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[p,i]of this._$Ep)this[p]=i;this._$Ep=void 0}let h=this.constructor.elementProperties;if(h.size>0)for(let[p,i]of h){let{wrapped:v}=i,r=this[p];v!==!0||this._$AL.has(p)||r===void 0||this.C(p,void 0,i,r)}}let x=!1,d=this._$AL;try{x=this.shouldUpdate(d),x?(this.willUpdate(d),this._$EO?.forEach((h)=>h.hostUpdate?.()),this.update(d)):this._$EM()}catch(h){throw x=!1,this._$EM(),h}x&&this._$AE(d)}willUpdate(x){}_$AE(x){this._$EO?.forEach((d)=>d.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(x)),this.updated(x)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(x){return!0}update(x){this._$Eq&&=this._$Eq.forEach((d)=>this._$ET(d,this[d])),this._$EM()}updated(x){}firstUpdated(x){}}I.elementStyles=[],I.shadowRootOptions={mode:"open"},I[h1("elementProperties")]=new Map,I[h1("finalized")]=new Map,Pd?.({ReactiveElement:I}),(E1.reactiveElementVersions??=[]).push("2.1.2");var w1=globalThis,j0=(x)=>x,X1=w1.trustedTypes,M0=X1?X1.createPolicy("lit-html",{createHTML:(x)=>x}):void 0;var C=`lit$${Math.random().toFixed(9).slice(2)}$`,H0="?"+C,Sd=`<${H0}>`,u=document,i1=()=>u.createComment(""),v1=(x)=>x===null||typeof x!="object"&&typeof x!="function",F1=Array.isArray,sd=(x)=>F1(x)||typeof x?.[Symbol.iterator]=="function";var p1=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,L0=/-->/g,A0=/>/g,m=RegExp(`>|[ 	
\f\r](?:([^\\s"'>=/]+)([ 	
\f\r]*=[ 	
\f\r]*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),c0=/'/g,G0=/"/g,O0=/^(?:script|style|textarea|title)$/i,$1=(x)=>(d,...h)=>({_$litType$:x,strings:d,values:h}),X=$1(1),n=$1(2),Ah=$1(3),b=Symbol.for("lit-noChange"),g=Symbol.for("lit-nothing"),D0=new WeakMap,_=u.createTreeWalker(u,129);function f0(x,d){if(!F1(x)||!x.hasOwnProperty("raw"))throw Error("invalid template strings array");return M0!==void 0?M0.createHTML(d):d}var Id=(x,d)=>{let h=x.length-1,p=[],i,v=d===2?"<svg>":d===3?"<math>":"",r=p1;for(let k=0;k<h;k++){let N=x[k],q,y,z=-1,W=0;for(;W<N.length&&(r.lastIndex=W,y=r.exec(N),y!==null);)W=r.lastIndex,r===p1?y[1]==="!--"?r=L0:y[1]!==void 0?r=A0:y[2]!==void 0?(O0.test(y[2])&&(i=RegExp("</"+y[2],"g")),r=m):y[3]!==void 0&&(r=m):r===m?y[0]===">"?(r=i??p1,z=-1):y[1]===void 0?z=-2:(z=r.lastIndex-y[2].length,q=y[1],r=y[3]===void 0?m:y[3]==='"'?G0:c0):r===G0||r===c0?r=m:r===L0||r===A0?r=p1:(r=m,i=void 0);let Q=r===m&&x[k+1].startsWith("/>")?" ":"";v+=r===p1?N+Sd:z>=0?(p.push(q),N.slice(0,z)+"$lit$"+N.slice(z)+C+Q):N+C+(z===-2?k:Q)}return[f0(x,v+(x[h]||"<?>")+(d===2?"</svg>":d===3?"</math>":"")),p]};class r1{constructor({strings:x,_$litType$:d},h){let p;this.parts=[];let i=0,v=0,r=x.length-1,k=this.parts,[N,q]=Id(x,d);if(this.el=r1.createElement(N,h),_.currentNode=this.el.content,d===2||d===3){let y=this.el.content.firstChild;y.replaceWith(...y.childNodes)}for(;(p=_.nextNode())!==null&&k.length<r;){if(p.nodeType===1){if(p.hasAttributes())for(let y of p.getAttributeNames())if(y.endsWith("$lit$")){let z=q[v++],W=p.getAttribute(y).split(C),Q=/([.?@])?(.*)/.exec(z);k.push({type:1,index:i,name:Q[2],strings:W,ctor:Q[1]==="."?P0:Q[1]==="?"?S0:Q[1]==="@"?s0:k1}),p.removeAttribute(y)}else y.startsWith(C)&&(k.push({type:6,index:i}),p.removeAttribute(y));if(O0.test(p.tagName)){let y=p.textContent.split(C),z=y.length-1;if(z>0){p.textContent=X1?X1.emptyScript:"";for(let W=0;W<z;W++)p.append(y[W],i1()),_.nextNode(),k.push({type:2,index:++i});p.append(y[z],i1())}}}else if(p.nodeType===8)if(p.data===H0)k.push({type:2,index:i});else{let y=-1;for(;(y=p.data.indexOf(C,y+1))!==-1;)k.push({type:7,index:i}),y+=C.length-1}i++}}static createElement(x,d){let h=u.createElement("template");return h.innerHTML=x,h}}function a(x,d,h=x,p){if(d===b)return d;let i=p!==void 0?h._$Co?.[p]:h._$Cl,v=v1(d)?void 0:d._$litDirective$;return i?.constructor!==v&&(i?._$AO?.(!1),v===void 0?i=void 0:(i=new v(x),i._$AT(x,h,p)),p!==void 0?(h._$Co??=[])[p]=i:h._$Cl=i),i!==void 0&&(d=a(x,i._$AS(x,d.values),i,p)),d}class V0{constructor(x,d){this._$AV=[],this._$AN=void 0,this._$AD=x,this._$AM=d}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(x){let{el:{content:d},parts:h}=this._$AD,p=(x?.creationScope??u).importNode(d,!0);_.currentNode=p;let i=_.nextNode(),v=0,r=0,k=h[0];for(;k!==void 0;){if(v===k.index){let N;k.type===2?N=new y1(i,i.nextSibling,this,x):k.type===1?N=new k.ctor(i,k.name,k.strings,this,x):k.type===6&&(N=new I0(i,this,x)),this._$AV.push(N),k=h[++r]}v!==k?.index&&(i=_.nextNode(),v++)}return _.currentNode=u,p}p(x){let d=0;for(let h of this._$AV)h!==void 0&&(h.strings!==void 0?(h._$AI(x,h,d),d+=h.strings.length-2):h._$AI(x[d])),d++}}class y1{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(x,d,h,p){this.type=2,this._$AH=g,this._$AN=void 0,this._$AA=x,this._$AB=d,this._$AM=h,this.options=p,this._$Cv=p?.isConnected??!0}get parentNode(){let x=this._$AA.parentNode,d=this._$AM;return d!==void 0&&x?.nodeType===11&&(x=d.parentNode),x}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(x,d=this){x=a(this,x,d),v1(x)?x===g||x==null||x===""?(this._$AH!==g&&this._$AR(),this._$AH=g):x!==this._$AH&&x!==b&&this._(x):x._$litType$!==void 0?this.$(x):x.nodeType!==void 0?this.T(x):sd(x)?this.k(x):this._(x)}O(x){return this._$AA.parentNode.insertBefore(x,this._$AB)}T(x){this._$AH!==x&&(this._$AR(),this._$AH=this.O(x))}_(x){this._$AH!==g&&v1(this._$AH)?this._$AA.nextSibling.data=x:this.T(u.createTextNode(x)),this._$AH=x}$(x){let{values:d,_$litType$:h}=x,p=typeof h=="number"?this._$AC(x):(h.el===void 0&&(h.el=r1.createElement(f0(h.h,h.h[0]),this.options)),h);if(this._$AH?._$AD===p)this._$AH.p(d);else{let i=new V0(p,this),v=i.u(this.options);i.p(d),this.T(v),this._$AH=i}}_$AC(x){let d=D0.get(x.strings);return d===void 0&&D0.set(x.strings,d=new r1(x)),d}k(x){F1(this._$AH)||(this._$AH=[],this._$AR());let d=this._$AH,h,p=0;for(let i of x)p===d.length?d.push(h=new y1(this.O(i1()),this.O(i1()),this,this.options)):h=d[p],h._$AI(i),p++;p<d.length&&(this._$AR(h&&h._$AB.nextSibling,p),d.length=p)}_$AR(x=this._$AA.nextSibling,d){for(this._$AP?.(!1,!0,d);x!==this._$AB;){let h=j0(x).nextSibling;j0(x).remove(),x=h}}setConnected(x){this._$AM===void 0&&(this._$Cv=x,this._$AP?.(x))}}class k1{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(x,d,h,p,i){this.type=1,this._$AH=g,this._$AN=void 0,this.element=x,this.name=d,this._$AM=p,this.options=i,h.length>2||h[0]!==""||h[1]!==""?(this._$AH=Array(h.length-1).fill(new String),this.strings=h):this._$AH=g}_$AI(x,d=this,h,p){let i=this.strings,v=!1;if(i===void 0)x=a(this,x,d,0),v=!v1(x)||x!==this._$AH&&x!==b,v&&(this._$AH=x);else{let r=x,k,N;for(x=i[0],k=0;k<i.length-1;k++)N=a(this,r[h+k],d,k),N===b&&(N=this._$AH[k]),v||=!v1(N)||N!==this._$AH[k],N===g?x=g:x!==g&&(x+=(N??"")+i[k+1]),this._$AH[k]=N}v&&!p&&this.j(x)}j(x){x===g?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,x??"")}}class P0 extends k1{constructor(){super(...arguments),this.type=3}j(x){this.element[this.name]=x===g?void 0:x}}class S0 extends k1{constructor(){super(...arguments),this.type=4}j(x){this.element.toggleAttribute(this.name,!!x&&x!==g)}}class s0 extends k1{constructor(x,d,h,p,i){super(x,d,h,p,i),this.type=5}_$AI(x,d=this){if((x=a(this,x,d,0)??g)===b)return;let h=this._$AH,p=x===g&&h!==g||x.capture!==h.capture||x.once!==h.once||x.passive!==h.passive,i=x!==g&&(h===g||p);p&&this.element.removeEventListener(this.name,this,h),i&&this.element.addEventListener(this.name,this,x),this._$AH=x}handleEvent(x){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,x):this._$AH.handleEvent(x)}}class I0{constructor(x,d,h){this.element=x,this.type=6,this._$AN=void 0,this._$AM=d,this.options=h}get _$AU(){return this._$AM._$AU}_$AI(x){a(this,x)}}var Cd=w1.litHtmlPolyfillSupport;Cd?.(r1,y1),(w1.litHtmlVersions??=[]).push("3.3.3");var C0=(x,d,h)=>{let p=h?.renderBefore??d,i=p._$litPart$;if(i===void 0){let v=h?.renderBefore??null;p._$litPart$=i=new y1(d.insertBefore(i1(),v),v,void 0,h??{})}return i._$AI(x),i};var m1=globalThis;class V extends I{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let x=super.createRenderRoot();return this.renderOptions.renderBefore??=x.firstChild,x}update(x){let d=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(x),this._$Do=C0(d,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return b}}V._$litElement$=!0,V.finalized=!0,m1.litElementHydrateSupport?.({LitElement:V});var Rd=m1.litElementPolyfillSupport;Rd?.({LitElement:V});(m1.litElementVersions??=[]).push("4.2.2");var R0=null;function w0(){let x=new URL("/app/assets/datastar.js",window.location.href).href;return R0??=import(x),R0}var t=null,F0=null;function Z1(x){class d extends x{#x=null;#d=!1;connectedCallback(){this.#d=!0,super.connectedCallback(),wd().then(async()=>{if(!this.#d)return;if(this.requestUpdate(),await this.updateComplete,await Fd(),this.#d)this.requestUpdate()})}performUpdate(){if(!this.isUpdatePending)return;let h=t;if(!h){super.performUpdate();return}this.#x?.();let p=!0;this.#x=h.effect(()=>{if(Object.keys(h.root),p){p=!1,super.performUpdate();return}this.requestUpdate()})}disconnectedCallback(){this.#d=!1,this.#x?.(),this.#x=null,super.disconnectedCallback()}signal(h,p){let i=t?.getPath(h);return _1(i===void 0?p:i)}}return d}async function wd(){if(t)return t;return F0??=w0(),t=await F0,t}async function Fd(){await Promise.resolve(),await new Promise((x)=>requestAnimationFrame(()=>x()))}function _1(x){if(Array.isArray(x))return x.map((d)=>_1(d));if(x&&typeof x==="object")return Object.fromEntries(Object.entries(x).map(([d,h])=>[d,_1(h)]));return x}var $0=d1`
  :host {
    color-scheme: dark;
    --canvas: #0b0b0d;
    --canvas-soft: #101013;
...
`;function R(x,d=12){if(x.length<=d)return x;return`${x.slice(0,d-1)}…`}function u1(x){if(!x)return"Not configured";let d=x.includes("@")?x.split("@").at(-1):x;return d.length>23?`${d.slice(0,16)}…${d.slice(-6)}`:d}function z1(x,d=Date.now()){let h=Date.parse(x);if(!Number.isFinite(h))return"—";let p=Math.max(0,Math.round((d-h)/1000));if(p<5)return"now";if(p<60)return`${p}s ago`;let i=Math.floor(p/60);if(i<60)return`${i}m ago`;let v=Math.floor(i/60);if(v<24)return`${v}h ago`;return`${Math.floor(v/24)}d ago`}function K1(x,d,h=Date.now()){if(!x)return"—";let p=Date.parse(x),i=d?Date.parse(d):h;if(!Number.isFinite(p)||!Number.isFinite(i)||i<p)return"—";let v=i-p;if(v<1000)return`${v}ms`;let r=v/1000;if(r<60)return`${r.toFixed(r<10?1:0)}s`;return`${Math.floor(r/60)}m ${Math.floor(r%60)}s`}function m0(x){let d=x.filter((p)=>["succeeded","success","failed","cancelled"].includes(p));if(d.length===0)return"—";let h=d.filter((p)=>p==="succeeded"||p==="success").length;return`${Math.round(h/d.length*100)}%`}function o(x){if(!Number.isFinite(x)||x<=0)return"—";let d=["B","KB","MB","GB","TB"],h=Math.min(Math.floor(Math.log(x)/Math.log(1024)),d.length-1),p=x/1024**h;return`${p>=10||Number.isInteger(p)?p.toFixed(0):p.toFixed(1)} ${d[h]}`}function G(x){if(!Number.isFinite(x))return"—";return`${Math.round(Math.max(0,Math.min(1,x))*100)}%`}function e(x){if(x==null||!Number.isFinite(x)||x<0)return"—";if(x<1000)return`${Math.round(x)}ms`;let d=x/1000;if(d<60)return`${d.toFixed(d<10?1:0)}s`;return`${Math.floor(d/60)}m ${Math.floor(d%60)}s`}function b1(x,d){if(!x)return null;if(typeof x==="function")return x(d);return x}function _0(x){if("cell"in x&&x.cell)return b1(x.cell.column.columnDef.cell,x.cell.getContext());if("header"in x&&x.header)return b1(x.header.column.columnDef.header,x.header.getContext());if("footer"in x&&x.footer)return b1(x.footer.column.columnDef.footer,x.footer.getContext());return null}var Y=function(x){return x[x.None=0]="None",x[x.Mutable=1]="Mutable",x[x.Watching=2]="Watching",x[x.RecursedCheck=4]="RecursedCheck",x[x.Recursed=8]="Recursed",x[x.Dirty=16]="Dirty",x[x.Pending=32]="Pending",x}({});function u0({update:x,notify:d,unwatched:h}){return{link:p,unlink:i,propagate:v,checkDirty:r,shallowPropagate:k};function p(q,y,z){let W=y.depsTail;if(W!==void 0&&W.dep===q)return;let Q=W!==void 0?W.nextDep:y.deps;if(Q!==void 0&&Q.dep===q){Q.version=z,y.depsTail=Q;return}let T=q.subsTail;if(T!==void 0&&T.version===z&&T.sub===y)return;let J=y.depsTail=q.subsTail={version:z,dep:q,sub:y,prevDep:W,nextDep:Q,prevSub:T,nextSub:void 0};if(Q!==void 0)Q.prevDep=J;if(W!==void 0)W.nextDep=J;else y.deps=J;if(T!==void 0)T.nextSub=J;else q.subs=J}function i(q,y=q.sub){let{dep:z,prevDep:W,nextDep:Q,nextSub:T,prevSub:J}=q;if(Q!==void 0)Q.prevDep=W;else y.depsTail=W;if(W!==void 0)W.nextDep=Q;else y.deps=Q;if(T!==void 0)T.prevSub=J;else z.subsTail=J;if(J!==void 0)J.nextSub=T;else if((z.subs=T)===void 0)h(z);return Q}function v(q){let y=q.nextSub,z;x:do{let W=q.sub,Q=W.flags;if(!(Q&(Y.RecursedCheck|Y.Recursed|Y.Dirty|Y.Pending)))W.flags=Q|Y.Pending;else if(!(Q&(Y.RecursedCheck|Y.Recursed)))Q=Y.None;else if(!(Q&Y.RecursedCheck))W.flags=Q&~Y.Recursed|Y.Pending;else if(!(Q&(Y.Dirty|Y.Pending))&&N(q,W))W.flags=Q|(Y.Recursed|Y.Pending),Q&=Y.Mutable;else Q=Y.None;if(Q&Y.Watching)d(W);if(Q&Y.Mutable){let T=W.subs;if(T!==void 0){let J=(q=T).nextSub;if(J!==void 0)z={value:y,prev:z},y=J;continue}}if((q=y)!==void 0){y=q.nextSub;continue}while(z!==void 0)if(q=z.value,z=z.prev,q!==void 0){y=q.nextSub;continue x}break}while(!0)}function r(q,y){let z,W=0,Q=!1;x:do{let T=q.dep,J=T.flags;if(y.flags&Y.Dirty)Q=!0;else if((J&(Y.Mutable|Y.Dirty))===(Y.Mutable|Y.Dirty)){if(x(T)){let Z=T.subs;if(Z.nextSub!==void 0)k(Z);Q=!0}}else if((J&(Y.Mutable|Y.Pending))===(Y.Mutable|Y.Pending)){if(q.nextSub!==void 0||q.prevSub!==void 0)z={value:q,prev:z};q=T.deps,y=T,++W;continue}if(!Q){let Z=q.nextDep;if(Z!==void 0){q=Z;continue}}while(W--){let Z=y.subs,K=Z.nextSub!==void 0;if(K)q=z.value,z=z.prev;else q=Z;if(Q){if(x(y)){if(K)k(Z);y=q.sub;continue}Q=!1}else y.flags&=~Y.Pending;y=q.sub;let E=q.nextDep;if(E!==void 0){q=E;continue x}}return Q}while(!0)}function k(q){do{let y=q.sub,z=y.flags;if((z&(Y.Pending|Y.Dirty))===Y.Pending){if(y.flags=z|Y.Dirty,(z&(Y.Watching|Y.RecursedCheck))===Y.Watching)d(y)}}while((q=q.nextSub)!==void 0)}function N(q,y){let z=y.depsTail;while(z!==void 0){if(z===q)return!0;z=z.prevDep}return!1}}function a0(x,d,h){let p=typeof x==="object",i=p?x:void 0;return{next:(p?x.next:x)?.bind(i),error:(p?x.error:d)?.bind(i),complete:(p?x.complete:h)?.bind(i)}}var o1=[],B1=0,{link:b0,unlink:$d,propagate:md,checkDirty:t0,shallowPropagate:o0}=u0({update(x){return x._update()},notify(x){o1[a1++]=x,x.flags&=~Y.Watching},unwatched(x){if(x.depsTail!==void 0)x.depsTail=void 0,x.flags=Y.Mutable|Y.Dirty,U1(x)}}),g1=0,a1=0,f,t1=0;function e1(x){try{++t1,x()}finally{if(!--t1)l1()}}function U1(x){let d=x.depsTail,h=d!==void 0?d.nextDep:x.deps;while(h!==void 0)h=$d(h,x)}function l1(){if(t1>0)return;while(g1<a1){let x=o1[g1];o1[g1++]=void 0,x.notify()}g1=0,a1=0}function n1(x,d){let h=typeof x==="function",p=x,i={_snapshot:h?void 0:x,subs:void 0,subsTail:void 0,deps:void 0,depsTail:void 0,flags:h?Y.None:Y.Mutable,get(){if(f!==void 0)b0(i,f,B1);return i._snapshot},subscribe(v){let r=a0(v),k={current:!1},N=_d(()=>{if(i.get(),!k.current)k.current=!0;else r.next?.(i._snapshot)});return{unsubscribe:()=>{N.stop()}}},_update(v){let r=f,k=d?.compare??Object.is;if(h)f=i,++B1,i.depsTail=void 0;else if(v===void 0)return!1;if(h)i.flags=Y.Mutable|Y.RecursedCheck;try{let N=i._snapshot,q=typeof v==="function"?v(N):v===void 0&&h?p(N):v;if(N===void 0||!k(N,q))return i._snapshot=q,!0;return!1}finally{if(f=r,h)i.flags&=~Y.RecursedCheck;U1(i)}}};if(h)i.flags=Y.Mutable|Y.Dirty,i.get=function(){let v=i.flags;if(v&Y.Dirty||v&Y.Pending&&t0(i.deps,i)){if(i._update()){let r=i.subs;if(r!==void 0)o0(r)}}else if(v&Y.Pending)i.flags=v&~Y.Pending;if(f!==void 0)b0(i,f,B1);return i._snapshot};else i.set=function(v){if(i._update(v)){let r=i.subs;if(r!==void 0)md(r),o0(r),l1()}};return i}function _d(x){let d=()=>{let p=f;f=h,++B1,h.depsTail=void 0,h.flags=Y.Watching|Y.RecursedCheck;try{return x()}finally{f=p,h.flags&=~Y.RecursedCheck,U1(h)}},h={deps:void 0,depsTail:void 0,subs:void 0,subsTail:void 0,flags:Y.Watching|Y.RecursedCheck,notify(){let p=this.flags;if(p&Y.Dirty||p&Y.Pending&&t0(this.deps,this))d();else this.flags=Y.Watching},stop(){this.flags=Y.None,this.depsTail=void 0,U1(this)}};return d(),h}function e0(){return{createOptionsStore:!0,wrapExternalAtoms:!1,addSubscription:()=>{throw Error("Feature not supported in current reactivity implementation")},unmount:()=>{throw Error("Feature not supported in current reactivity implementation")},schedule:(x)=>queueMicrotask(()=>x()),batch:e1,untrack:(x)=>x(),createReadonlyAtom:(x,d)=>{return n1(()=>x(),{compare:d===null||d===void 0?void 0:d.compare})},createWritableAtom:(x,d)=>{return n1(x,{compare:d===null||d===void 0?void 0:d.compare})}}}function P(x,d){return typeof x==="function"?x(d):x}function D(x){if(Array.isArray(x))return x.map(D);if(x&&typeof x==="object"){let d=Object.getPrototypeOf(x);if(d!==Object.prototype&&d!==null)return x;let h={},p=Object.keys(x);for(let i=0;i<p.length;i++){let v=p[i];h[v]=D(x[v])}return h}return x}function j1(x,d){return(h)=>{var p;(((p=d.options.atoms)===null||p===void 0?void 0:p[x])??d.baseAtoms[x]).set((i)=>P(h,i))}}function M1(x){return x instanceof Function}function l0(x,d){let h=[],p=(i)=>{i.forEach((v)=>{h.push(v);let r=d(v);if(r.length)p(r)})};return p(x),h}var ud=({fn:x,memoDeps:d,onAfterCompare:h,onAfterUpdate:p,onBeforeCompare:i,onBeforeUpdate:v})=>{let r=[],k;return(q)=>{i===null||i===void 0||i();let y=d===null||d===void 0?void 0:d(q),z=!y||y.length!==(r===null||r===void 0?void 0:r.length);if(!z&&y){for(let W=0;W<y.length;W++)if(y[W]!==r[W]){z=!0;break}}if(h===null||h===void 0||h(z),!z)return k;return r=y,v===null||v===void 0||v(),k=x(...y??[]),p===null||p===void 0||p(k),k}},bd=(x,d)=>{x=String(x);while(x.length<d)x=" "+x;return x};function l({feature:x,fnName:d,objectId:h,onAfterUpdate:p,table:i,...v}){let r,k,N,q,y=0,z,W;function Q(Z,K){var E;let S=y===0?"(1st run)":K?"(rerun #"+y+")":"(cache)";y++,console.groupCollapsed(`%c⏱ ${bd(`${Z.toFixed(1)} ms`,12)} %c${S}%c ${d}%c ${h?`(${d.split(".")[0]}Id: ${h})`:""}`,`font-size: .6rem; font-weight: bold; ${K?`color: hsl(
        ${Math.max(0,Math.min(120-Math.log10(Z)*60,120))}deg 100% 31%);`:""} `,`color: ${y<2?"#FF00FF":"#FF1493"}`,"color: #666","color: #87CEEB"),console.info({feature:x,state:i.store.state,deps:(E=v.memoDeps)===null||E===void 0?void 0:E.toString()}),console.trace(),console.groupEnd()}let T=()=>{if(!p)return;let{schedule:Z,untrack:K}=i._reactivity;Z(()=>K(()=>p()))};return ud({...v,...{onAfterUpdate:()=>{T()}}})}function xx(x,d="_"){let[h,p]=x.split(d);return{fnKey:p,fnName:`${h}.${p}`,parentName:h}}function L(x,d,h){for(let[p,{fn:i,memoDeps:v}]of Object.entries(h)){let{fnKey:r,fnName:k}=xx(p);d[r]=v?l({memoDeps:v,fn:i,fnName:k,table:d,feature:x}):i}}function H(x,d,h,p){for(let[i,{fn:v,memoDeps:r}]of Object.entries(p)){let{fnKey:k,fnName:N}=xx(i);if(r){let q=`_memo_${k}`;d[k]=function(...y){if(!this[q]){let z=this;this[q]=l({memoDeps:(W)=>r(z,W),fn:(...W)=>v(z,...W),fnName:N,objectId:z.id,table:h,feature:x})}return this[q](...y)}}else d[k]=function(...q){return v(this,...q)}}}function A(x,d,h,...p){var i;return((i=x[d])===null||i===void 0?void 0:i.call(x,...p))??h(x,...p)}function dx(x){return x.row.getValue(x.column.id)}function hx(x){return x.getValue()??x.table.options.renderFallbackValue}function px(x){return{table:x.table,column:x.column,row:x.row,cell:x,getValue:()=>x.getValue(),renderValue:()=>x.renderValue()}}var ix={assignCellPrototype:(x,d)=>{H("coreCellsFeature",x,d,{cell_getValue:{fn:(h)=>dx(h)},cell_renderValue:{fn:(h)=>hx(h)},cell_getContext:{fn:(h)=>px(h),memoDeps:(h)=>[h]}})}};function od(x){if(!x._headerPrototype){x._headerPrototype={table:x};let p=Object.values(x._features);for(let i=0;i<p.length;i++){var d,h;(d=(h=p[i]).assignHeaderPrototype)===null||d===void 0||d.call(h,x._headerPrototype,x)}}return x._headerPrototype}function x0(x,d,h){let p=od(x),i=Object.create(p);return i.colSpan=0,i.column=d,i.depth=h.depth,i.headerGroup=null,i.id=h.id??d.id,i.index=h.index,i.isPlaceholder=!!h.isPlaceholder,i.placeholderId=h.placeholderId,i.rowSpan=0,i.subHeaders=[],i}function vx(){return{left:[],right:[]}}function w(x){var d;let h=x.columns;return(h.length?h.some((p)=>A(p,"getIsVisible",w)):(d=x.table.atoms.columnVisibility)===null||d===void 0||(d=d.get())===null||d===void 0?void 0:d[x.id])??!0}function rx(x){return x.getAllLeafColumns().filter((d)=>A(d,"getIsVisible",w))}function d0(x,d,h,p){var i;let v=0,r=(y,z=1)=>{v=Math.max(v,z);for(let W=0;W<y.length;W++){let Q=y[W];if(A(Q,"getIsVisible",w)){if(Q.columns.length)r(Q.columns,z+1)}}};r(x);let k=[],N=(y,z)=>{let W={depth:z,id:[p,`${z}`].filter(Boolean).join("_"),headers:[]},Q=[];if(y.forEach((T)=>{let J=Q[Q.length-1],Z=T.column.depth===W.depth,K,E=!1;if(Z&&T.column.parent)K=T.column.parent;else K=T.column,E=!0;if(J&&J.column===K)J.subHeaders.push(T);else{let S=x0(h,K,{id:[p,z,K.id,T.id].filter(Boolean).join("_"),isPlaceholder:E,placeholderId:E?`${Q.filter(($)=>$.column===K).length}`:void 0,depth:z,index:Q.length});S.subHeaders.push(T),Q.push(S)}W.headers.push(T),T.headerGroup=W}),k.push(W),z>0)N(Q,z-1)};N(d.map((y,z)=>x0(h,y,{depth:v,index:z})),v-1),k.reverse();let q=(y)=>{let z=[];for(let W=0;W<y.length;W++){let Q=y[W];if(!A(Q.column,"getIsVisible",w))continue;let T=0,J=1/0;if(Q.subHeaders.length){let Z=q(Q.subHeaders);for(let K=0;K<Z.length;K++){let E=Z[K];if(T+=E.colSpan,E.rowSpan<J)J=E.rowSpan}}else T=1,J=0;Q.colSpan=T,Q.rowSpan=J,z.push({colSpan:T,rowSpan:Q.rowSpan})}return z};return q(((i=k[0])===null||i===void 0?void 0:i.headers)??[]),k}function ad(x){if(!x._columnPrototype){x._columnPrototype={table:x};let p=Object.values(x._features);for(let i=0;i<p.length;i++){var d,h;(d=(h=p[i]).assignColumnPrototype)===null||d===void 0||d.call(h,x._columnPrototype,x)}}return x._columnPrototype}function yx(x,d,h,p){let i={...x.getDefaultColumnDef(),...d},v=i.accessorKey,r=i.id??(v?v.replaceAll(".","_"):void 0)??(typeof i.header==="string"?i.header:void 0),k;if(i.accessorFn)k=i.accessorFn;else if(v)if(v.includes(".")){let y=v.split(".");k=(z)=>{let W=z;for(let Q=0;Q<y.length;Q++){let T=y[Q];W=W===null||W===void 0?void 0:W[T]}return W}}else k=(y)=>y[i.accessorKey];if(!r)throw Error();let N=ad(x),q=Object.create(N);return q.accessorFn=k,q.columnDef=i,q.columns=[],q.depth=h,q.id=`${String(r)}`,q.parent=p,q}function h0(x){var d;let h=(d=x.atoms.columnOrder)===null||d===void 0?void 0:d.get();return(p)=>{let i=[];if(!(h===null||h===void 0?void 0:h.length))i=p;else{let v=new Map;for(let r=0;r<p.length;r++){let k=p[r];v.set(k.id,k)}for(let r=0;r<h.length;r++){let k=h[r],N=v.get(k);if(N)i.push(N),v.delete(k)}for(let r=0;r<p.length;r++){let k=p[r];if(v.has(k.id))i.push(k)}}return td(x,i)}}function td(x,d){var h;let p=((h=x.atoms.grouping)===null||h===void 0?void 0:h.get())??[],{groupedColumnMode:i}=x.options;if(!p.length||!i)return d;let v=d.filter((N)=>!p.includes(N.id));if(i==="remove")return v;let r=new Map;for(let N=0;N<d.length;N++){let q=d[N];r.set(q.id,q)}let k=[];for(let N=0;N<p.length;N++){let q=r.get(p[N]);if(q)k.push(q)}return[...k,...v]}function kx(x){return[x,...x.columns.flatMap((d)=>d.getFlatColumns())]}function zx(x){if(x.columns.length){let d=x.columns.flatMap((h)=>h.getLeafColumns());return A(x.table,"getOrderColumns",h0)(d)}return[x]}function qx(x){return{header:(d)=>{let h=d.header.column.columnDef;if(h.accessorKey)return h.accessorKey;if(h.accessorFn)return h.id;return null},cell:(d)=>{var h,p;return((h=d.renderValue())===null||h===void 0||(p=h.toString)===null||p===void 0?void 0:p.call(h))??null},...Object.values(x._features).reduce((d,h)=>{var p;return Object.assign(d,(p=h.getDefaultColumnDef)===null||p===void 0?void 0:p.call(h))},{}),...x.options.defaultColumn}}function Nx(x){let d=(h,p,i=0)=>{return h.map((v)=>{let r=yx(x,v,i,p),k=v;return r.columns=k.columns?d(k.columns,r,i+1):[],r})};return d(x.options.columns)}function Qx(x){return x.getAllColumns().flatMap((d)=>d.getFlatColumns())}function Tx(x){let d={},h=x.getAllFlatColumns();for(let p=0;p<h.length;p++){let i=h[p];d[i.id]=i}return d}function Wx(x){let d=x.getAllColumns().flatMap((h)=>h.getLeafColumns());return A(x,"getOrderColumns",h0)(d)}function Yx(x){let d={},h=x.getAllLeafColumns();for(let p=0;p<h.length;p++){let i=h[p];d[i.id]=i}return d}function L1(x,d){return x.getAllFlatColumnsById()[d]}var Jx={assignColumnPrototype:(x,d)=>{H("coreColumnsFeature",x,d,{column_getFlatColumns:{fn:(h)=>kx(h),memoDeps:(h)=>[h.table.options.columns]},column_getLeafColumns:{fn:(h)=>zx(h),memoDeps:(h)=>{var p,i;return[(p=h.table.atoms.columnOrder)===null||p===void 0?void 0:p.get(),(i=h.table.atoms.grouping)===null||i===void 0?void 0:i.get(),h.table.options.columns,h.table.options.groupedColumnMode]}}})},constructTableAPIs:(x)=>{L("coreColumnsFeature",x,{table_getDefaultColumnDef:{fn:()=>qx(x),memoDeps:()=>[x.options.defaultColumn]},table_getAllColumns:{fn:()=>Nx(x),memoDeps:()=>[x.options.columns]},table_getAllFlatColumns:{fn:()=>Qx(x),memoDeps:()=>[x.options.columns]},table_getAllFlatColumnsById:{fn:()=>Tx(x),memoDeps:()=>[x.options.columns]},table_getAllLeafColumns:{fn:()=>Wx(x),memoDeps:()=>{var d,h;return[(d=x.atoms.columnOrder)===null||d===void 0?void 0:d.get(),(h=x.atoms.grouping)===null||h===void 0?void 0:h.get(),x.options.columns,x.options.groupedColumnMode]}},table_getAllLeafColumnsById:{fn:()=>Yx(x),memoDeps:()=>[x.getAllLeafColumns()]},table_getColumn:{fn:(d)=>L1(x,d)}})}};function Ex(x){let d=[],h=(p)=>{if(p.subHeaders.length)p.subHeaders.map(h);d.push(p)};return h(x),d}function Xx(x){return{column:x.column,header:x,table:x.column.table}}function Zx(x){var d;let{left:h,right:p}=((d=x.atoms.columnPinning)===null||d===void 0?void 0:d.get())??vx(),i=x.getAllColumns(),v=A(x,"getVisibleLeafColumns",rx);if(!h.length&&!p.length)return d0(i,v,x);let r=x.getAllLeafColumnsById(),k=[];for(let y=0;y<h.length;y++){let z=r[h[y]];if(z&&A(z,"getIsVisible",w))k.push(z)}let N=[];for(let y=0;y<p.length;y++){let z=r[p[y]];if(z&&A(z,"getIsVisible",w))N.push(z)}let q=v.filter((y)=>!h.includes(y.id)&&!p.includes(y.id));return d0(i,[...k,...q,...N],x)}function Kx(x){return[...x.getHeaderGroups()].reverse()}function gx(x){let d=x.getHeaderGroups(),h=[];for(let p=0;p<d.length;p++){let i=d[p].headers;for(let v=0;v<i.length;v++)h.push(i[v])}return h}function Bx(x){var d;let h=((d=x.getHeaderGroups()[0])===null||d===void 0?void 0:d.headers)??[],p=[];for(let i=0;i<h.length;i++){let v=h[i].getLeafHeaders();for(let r=0;r<v.length;r++)p.push(v[r])}return p}var Ux={assignHeaderPrototype:(x,d)=>{H("coreHeadersFeature",x,d,{header_getLeafHeaders:{fn:(h)=>Ex(h),memoDeps:(h)=>[h.column.table.options.columns]},header_getContext:{fn:(h)=>Xx(h),memoDeps:(h)=>[h.column.table.options.columns]}})},constructTableAPIs:(x)=>{L("coreHeadersFeature",x,{table_getHeaderGroups:{fn:()=>Zx(x),memoDeps:()=>{var d,h,p,i;return[x.options.columns,(d=x.atoms.columnOrder)===null||d===void 0?void 0:d.get(),(h=x.atoms.grouping)===null||h===void 0?void 0:h.get(),(p=x.atoms.columnPinning)===null||p===void 0?void 0:p.get(),(i=x.atoms.columnVisibility)===null||i===void 0?void 0:i.get(),x.options.groupedColumnMode]}},table_getFooterGroups:{fn:()=>Kx(x),memoDeps:()=>[x.getHeaderGroups()]},table_getFlatHeaders:{fn:()=>gx(x),memoDeps:()=>[x.getHeaderGroups()]},table_getLeafHeaders:{fn:()=>Bx(x),memoDeps:()=>[x.getHeaderGroups()]}})}};function ed(x){if(!x._rowPrototype){x._rowPrototype={table:x};let p=Object.values(x._features);for(let i=0;i<p.length;i++){var d,h;(d=(h=p[i]).assignRowPrototype)===null||d===void 0||d.call(h,x._rowPrototype,x)}}return x._rowPrototype}var q1=(x,d,h,p,i,v,r)=>{let k=ed(x),N=Object.create(k);N._uniqueValuesCache={},N._valuesCache={},N.depth=i,N.id=d,N.index=p,N.original=h,N.parentId=r,N.subRows=v??[];let q=Object.values(x._features);for(let W=0;W<q.length;W++){var y,z;(y=(z=q[W]).initRowInstanceData)===null||y===void 0||y.call(z,N)}return N};var p0=0;function A1(x){if(x.options.autoResetAll??x.options.autoResetPageIndex??!x.options.manualPagination)dh(x)}function ld(x,d){var h,p;let i=(v)=>{return P(d,v)};return(h=(p=x.options).onPaginationChange)===null||h===void 0?void 0:h.call(p,i)}function xh(x,d){ld(x,(h)=>{let p=P(d,h.pageIndex),i=typeof x.options.pageCount>"u"||x.options.pageCount===-1?Number.MAX_SAFE_INTEGER:x.options.pageCount-1;return p=Math.max(0,Math.min(p,i)),{...h,pageIndex:p}})}function dh(x,d){var h,p;let i=((h=x.atoms.pagination)===null||h===void 0||(h=h.get())===null||h===void 0?void 0:h.pageIndex)??p0,v=d?p0:((p=x.initialState.pagination)===null||p===void 0?void 0:p.pageIndex)??p0;if(v===i)return;xh(x,v)}function N1(){return(x)=>{return l({feature:"coreRowModelsFeature",table:x,fnName:"table.getCoreRowModel",memoDeps:()=>[x.options.data],fn:()=>hh(x,x.options.data),onAfterUpdate:()=>A1(x)})}}function hh(x,d){let h={rows:[],flatRows:[],rowsById:{}},p=(i,v=0,r)=>{let k=[];for(let q=0;q<i.length;q++){let y=i[q],z=q1(x,x.getRowId(y,q,r),y,q,v,void 0,r===null||r===void 0?void 0:r.id);if(h.flatRows.push(z),h.rowsById[z.id]=z,k.push(z),x.options.getSubRows){var N;if(z.originalSubRows=x.options.getSubRows(y,q),(N=z.originalSubRows)===null||N===void 0?void 0:N.length)z.subRows=p(z.originalSubRows,v+1,z)}}return k};return h.rows=p(d),h}function nx(x){if(!x._rowModels.coreRowModel){var d,h;x._rowModels.coreRowModel=((d=(h=x.options.features).coreRowModel)===null||d===void 0?void 0:d.call(h,x))??N1()(x)}return x._rowModels.coreRowModel()}function jx(x){return x.getCoreRowModel()}function Mx(x){if(!x._rowModels.filteredRowModel){var d,h;x._rowModels.filteredRowModel=(d=(h=x.options.features).filteredRowModel)===null||d===void 0?void 0:d.call(h,x)}if(x.options.manualFiltering||!x._rowModels.filteredRowModel)return x.getPreFilteredRowModel();return x._rowModels.filteredRowModel()}function Lx(x){return x.getFilteredRowModel()}function Ax(x){if(!x._rowModels.groupedRowModel){var d,h;x._rowModels.groupedRowModel=(d=(h=x.options.features).groupedRowModel)===null||d===void 0?void 0:d.call(h,x)}if(x.options.manualGrouping||!x._rowModels.groupedRowModel)return x.getPreGroupedRowModel();return x._rowModels.groupedRowModel()}function cx(x){return x.getGroupedRowModel()}function Gx(x){if(!x._rowModels.sortedRowModel){var d,h;x._rowModels.sortedRowModel=(d=(h=x.options.features).sortedRowModel)===null||d===void 0?void 0:d.call(h,x)}if(x.options.manualSorting||!x._rowModels.sortedRowModel)return x.getPreSortedRowModel();return x._rowModels.sortedRowModel()}function Dx(x){return x.getSortedRowModel()}function Hx(x){if(!x._rowModels.expandedRowModel){var d,h;x._rowModels.expandedRowModel=(d=(h=x.options.features).expandedRowModel)===null||d===void 0?void 0:d.call(h,x)}if(x.options.manualExpanding||!x._rowModels.expandedRowModel)return x.getPreExpandedRowModel();return x._rowModels.expandedRowModel()}function Ox(x){return x.getExpandedRowModel()}function fx(x){if(!x._rowModels.paginatedRowModel){var d,h;x._rowModels.paginatedRowModel=(d=(h=x.options.features).paginatedRowModel)===null||d===void 0?void 0:d.call(h,x)}if(x.options.manualPagination||!x._rowModels.paginatedRowModel)return x.getPrePaginatedRowModel();return x._rowModels.paginatedRowModel()}function Vx(x){return x.getPaginatedRowModel()}var Px={constructTableAPIs:(x)=>{L("coreRowModelsFeature",x,{table_getCoreRowModel:{fn:()=>nx(x)},table_getPreFilteredRowModel:{fn:()=>jx(x)},table_getFilteredRowModel:{fn:()=>Mx(x)},table_getPreGroupedRowModel:{fn:()=>Lx(x)},table_getGroupedRowModel:{fn:()=>Ax(x)},table_getPreSortedRowModel:{fn:()=>cx(x)},table_getSortedRowModel:{fn:()=>Gx(x)},table_getPreExpandedRowModel:{fn:()=>Dx(x)},table_getExpandedRowModel:{fn:()=>Hx(x)},table_getPrePaginatedRowModel:{fn:()=>Ox(x)},table_getPaginatedRowModel:{fn:()=>fx(x)},table_getRowModel:{fn:()=>Vx(x)}})}};function ph(x){if(!x._cellPrototype){x._cellPrototype={table:x};let p=Object.values(x._features);for(let i=0;i<p.length;i++){var d,h;(d=(h=p[i]).assignCellPrototype)===null||d===void 0||d.call(h,x._cellPrototype,x)}}return x._cellPrototype}function Sx(x,d,h){let p=ph(h),i=Object.create(p);return i.column=x,i.id=`${d.id}_${x.id}`,i.row=d,i}function sx(x,d){if(x._valuesCache.hasOwnProperty(d))return x._valuesCache[d];let h=x.table.getColumn(d);if(!(h===null||h===void 0?void 0:h.accessorFn))return;return x._valuesCache[d]=h.accessorFn(x.original,x.index),x._valuesCache[d]}function Ix(x,d){if(x._uniqueValuesCache.hasOwnProperty(d))return x._uniqueValuesCache[d];let h=x.table.getColumn(d);if(!(h===null||h===void 0?void 0:h.accessorFn))return;if(!h.columnDef.getUniqueValues)return x._uniqueValuesCache[d]=[x.getValue(d)],x._uniqueValuesCache[d];return x._uniqueValuesCache[d]=h.columnDef.getUniqueValues(x.original,x.index),x._uniqueValuesCache[d]}function Cx(x,d){return x.getValue(d)??x.table.options.renderFallbackValue}function Rx(x){return l0(x.subRows,(d)=>d.subRows)}function wx(x){return x.parentId?x.table.getRow(x.parentId,!0):void 0}function Fx(x){let d=[],h=x;while(!0){let p=h.getParentRow();if(!p)break;d.push(p),h=p}return d.reverse()}function $x(x){let d=x.table.getAllLeafColumns(),h=Array(d.length);for(let p=0;p<d.length;p++)h[p]=Sx(d[p],x,x.table);return h}function mx(x){let d={},h=x.getAllCells();for(let p=0;p<h.length;p++){let i=h[p];d[i.column.id]=i}return d}function _x(x,d,h,p){var i,v;return((i=(v=d.options).getRowId)===null||i===void 0?void 0:i.call(v,x,h,p))??`${p?[p.id,h].join("."):h}`}function ux(x,d,h){let p=(h?x.getPrePaginatedRowModel():x.getRowModel()).rowsById[d];if(!p){if(p=x.getCoreRowModel().rowsById[d],!p)throw Error()}return p}var bx={assignRowPrototype:(x,d)=>{H("coreRowsFeature",x,d,{row_getAllCellsByColumnId:{fn:(h)=>mx(h),memoDeps:(h)=>[h.getAllCells()]},row_getAllCells:{fn:(h)=>$x(h),memoDeps:(h)=>[h.table.getAllLeafColumns()]},row_getLeafRows:{fn:(h)=>Rx(h)},row_getParentRow:{fn:(h)=>wx(h)},row_getParentRows:{fn:(h)=>Fx(h)},row_getUniqueValues:{fn:(h,p)=>Ix(h,p)},row_getValue:{fn:(h,p)=>sx(h,p)},row_renderValue:{fn:(h,p)=>Cx(h,p)}})},constructTableAPIs:(x)=>{L("coreRowsFeature",x,{table_getRowId:{fn:(d,h,p)=>_x(d,x,h,p)},table_getRow:{fn:(d,h)=>ux(x,d,h)}})}};function i0(x){let d=x.options.state;if(!d)return;x._reactivity.batch(()=>{for(let h in d){let p=x.baseAtoms[h];if(!p)continue;let i=d[h];if(i!==p.get())p.set(()=>i)}})}function ox(x){let d=D(x.initialState);x._reactivity.batch(()=>{let h=Object.keys(d);for(let p=0;p<h.length;p++){let i=h[p];x.baseAtoms[i].set(d[i])}})}function ih(x,d){if(x.options.mergeOptions)return x.options.mergeOptions(x.options,d);return{...x.options,...d}}function ax(x,d){let h=P(d,x.options),{features:p,atoms:i,initialState:v}=x.options,r=Object.assign(ih(x,h),{features:p,atoms:i,initialState:v});if(x.optionsStore)x.optionsStore.set(()=>r);else x.options=r;i0(x)}var tx={constructTableAPIs:(x)=>{L("coreTablesFeature",x,{table_reset:{fn:()=>ox(x)},table_setOptions:{fn:(d)=>ax(x,d)}})}};var ex={coreCellsFeature:ix,coreColumnsFeature:Jx,coreHeadersFeature:Ux,coreRowModelsFeature:Px,coreRowsFeature:bx,coreTablesFeature:tx};function v0(x){return x}function lx(x){let d=x;if(Object.defineProperty(x,"state",{get(){return x.get()}}),"set"in x)d.setState=x.set.bind(x);return d}function xd(x,d={}){return Object.values(x).forEach((h)=>{var p;d=((p=h.getInitialState)===null||p===void 0?void 0:p.call(h,d))??d}),D(d)}function r0(x){let d=x.features.coreReactivityFeature,{aggregationFns:h,columnMeta:p,coreRowModel:i,expandedRowModel:v,facetedMinMaxValues:r,facetedRowModel:k,facetedUniqueValues:N,filterFns:q,filterMeta:y,filteredRowModel:z,groupedRowModel:W,paginatedRowModel:Q,sortFns:T,sortedRowModel:J,tableMeta:Z,...K}=x.features,E={_reactivity:d,_features:{...ex,...K},_rowModels:{},_rowModelFns:{aggregationFns:h,filterFns:q,sortFns:T},baseAtoms:{},atoms:{}},S=Object.values(E._features),$={...S.reduce((B,U)=>{var M;return Object.assign(B,(M=U.getDefaultTableOptions)===null||M===void 0?void 0:M.call(U,E))},{}),...x};if(d.wrapExternalAtoms&&$.atoms)for(let[B,U]of Object.entries($.atoms)){let M=U,s=d.createWritableAtom(M.get(),{debugName:`externalAtom/${B}`});$.atoms[B]=s;let S1=!1,Ld=M.subscribe((s1)=>{if(S1)return;s.set(s1)}),Ad=s.subscribe((s1)=>{S1=!0,M.set(s1),S1=!1});d.addSubscription(Ld),d.addSubscription(Ad)}if(d.createOptionsStore)E.optionsStore=d.createWritableAtom($,{debugName:"table/optionsStore"}),Object.defineProperty(E,"options",{configurable:!0,enumerable:!0,get(){return E.optionsStore.get()},set(B){E.optionsStore.set(()=>B)}});else E.options=$;E.initialState=xd(E._features,E.options.initialState);let T1=Object.keys(E.initialState);for(let B=0;B<T1.length;B++){let U=T1[B];E.baseAtoms[U]=d.createWritableAtom(E.initialState[U],{debugName:`table/baseAtoms/${U}`}),E.atoms[U]=d.createReadonlyAtom(()=>{let M=E.options.atoms,s=M===null||M===void 0?void 0:M[U];if(s)return s.get();return E.baseAtoms[U].get()},{debugName:`table/atoms/${U}`})}i0(E),E.store=lx(d.createReadonlyAtom(()=>{let B={};for(let U=0;U<T1.length;U++){let M=T1[U];B[M]=E.atoms[M].get()}return B},{debugName:"table/store"}));for(let B=0;B<S.length;B++){var P1,X0;(P1=(X0=S[B]).constructTableAPIs)===null||P1===void 0||P1.call(X0,E)}return E}var y0=Object.assign((x,d,h)=>{return x.getValue(d)===h},{autoRemove:(x)=>j(x)}),dd=Object.assign((x,d,h)=>{return x.getValue(d)==h},{autoRemove:(x)=>j(x)}),hd=Object.assign((x,d,h)=>{var p;return Boolean((p=x.getValue(d))===null||p===void 0?void 0:p.toString().includes(String(h)))},{autoRemove:(x)=>j(x)}),c1=Object.assign((x,d,h)=>{var p;return Boolean((p=x.getValue(d))===null||p===void 0?void 0:p.toString().toLowerCase().includes(String(h).toLowerCase()))},{autoRemove:(x)=>j(x)}),pd=Object.assign((x,d,h)=>{var p;return((p=x.getValue(d))===null||p===void 0?void 0:p.toString().toLowerCase())===String(h).toLowerCase()},{autoRemove:(x)=>j(x)}),vh=Object.assign((x,d,h)=>{var p;return((p=x.getValue(d))===null||p===void 0?void 0:p.toString())===String(h)},{autoRemove:(x)=>j(x)}),G1=Object.assign((x,d,h)=>{let p=x.getValue(d),i=p===null||p===void 0?0:+p,v=Number(h);if(!isNaN(v)&&!isNaN(i))return i>v;return(p??"").toString().toLowerCase().trim()>String(h).toLowerCase().trim()},{resolveFilterValue:(x)=>j(x)}),k0=Object.assign((x,d,h)=>{return G1(x,d,h)||y0(x,d,h)},{resolveFilterValue:(x)=>j(x)}),id=Object.assign((x,d,h)=>{return!k0(x,d,h)},{resolveFilterValue:(x)=>j(x)}),vd=Object.assign((x,d,h)=>{return!G1(x,d,h)},{resolveFilterValue:(x)=>j(x)}),rh=Object.assign((x,d,h)=>(["",void 0].includes(h[0])||G1(x,d,h[0]))&&(!isNaN(Number(h[0]))&&!isNaN(Number(h[1]))&&Number(h[0])>Number(h[1])||["",void 0].includes(h[1])||id(x,d,h[1])),{autoRemove:(x)=>!x}),yh=Object.assign((x,d,h)=>(["",void 0].includes(h[0])||k0(x,d,h[0]))&&(!isNaN(Number(h[0]))&&!isNaN(Number(h[1]))&&Number(h[0])>Number(h[1])||["",void 0].includes(h[1])||vd(x,d,h[1])),{autoRemove:(x)=>!x}),rd=Object.assign((x,d,h)=>{let[p,i]=h,v=x.getValue(d);return v>=p&&v<=i},{resolveFilterValue:(x)=>{let[d,h]=x,p=typeof d!=="number"?parseFloat(d):d,i=typeof h!=="number"?parseFloat(h):h,v=d===null||Number.isNaN(p)?-1/0:p,r=h===null||Number.isNaN(i)?1/0:i;if(v>r){let k=v;v=r,r=k}return[v,r]},autoRemove:(x)=>j(x)||j(x[0])&&j(x[1])}),yd=(x,d,h)=>{return h.some((p)=>x.getValue(d)===p)},kd=Object.assign((x,d,h)=>{return h.some((p)=>x.getValue(d).includes(p))},{autoRemove:(x)=>j(x)||!(x===null||x===void 0?void 0:x.length)}),zd=Object.assign((x,d,h)=>{let p=x.getValue(d);if(!Array.isArray(p))return!1;return!h.some((i)=>!p.includes(i))},{autoRemove:(x)=>j(x)||!(x===null||x===void 0?void 0:x.length)}),qd=Object.assign((x,d,h)=>{let p=x.getValue(d);if(!Array.isArray(p))return!1;return h.some((i)=>p.includes(i))},{autoRemove:(x)=>j(x)||!(x===null||x===void 0?void 0:x.length)}),z0={arrIncludes:kd,arrIncludesAll:zd,arrHas:yd,arrIncludesSome:qd,between:rh,betweenInclusive:yh,equals:y0,equalsString:pd,inNumberRange:rd,includesString:c1,includesStringSensitive:hd,weakEquals:dd};function j(x){return x===void 0||x===null||x===""}function Nd(){return[]}function q0(x){let d=x.table._rowModelFns.filterFns,h=x.table.getCoreRowModel().flatRows[0],p=h?h.getValue(x.id):void 0;if(typeof p==="string")return d===null||d===void 0?void 0:d.includesString;if(typeof p==="number")return d===null||d===void 0?void 0:d.inNumberRange;if(typeof p==="boolean")return d===null||d===void 0?void 0:d.equals;if(p!==null&&typeof p==="object")return d===null||d===void 0?void 0:d.equals;if(Array.isArray(p))return d===null||d===void 0?void 0:d.arrIncludes;return d===null||d===void 0?void 0:d.weakEquals}function x1(x){let d=null,h=x.table._rowModelFns.filterFns;return d=M1(x.columnDef.filterFn)?x.columnDef.filterFn:x.columnDef.filterFn==="auto"?q0(x):h===null||h===void 0?void 0:h[x.columnDef.filterFn],d??void 0}function Qd(x){return(x.columnDef.enableColumnFilter??!0)&&(x.table.options.enableColumnFilters??!0)&&(x.table.options.enableFilters??!0)&&!!x.accessorFn}function Td(x){return N0(x)>-1}function Wd(x){var d;return(d=x.table.atoms.columnFilters)===null||d===void 0||(d=d.get())===null||d===void 0||(d=d.find((h)=>h.id===x.id))===null||d===void 0?void 0:d.value}function N0(x){var d;return((d=x.table.atoms.columnFilters)===null||d===void 0||(d=d.get())===null||d===void 0?void 0:d.findIndex((h)=>h.id===x.id))??-1}function Yd(x,d){D1(x.table,(h)=>{let p=x1(x),i=h.find((k)=>k.id===x.id),v=P(d,i?i.value:void 0);if(Ed(p,v,x))return h.filter((k)=>k.id!==x.id);let r={id:x.id,value:v};if(i)return h.map((k)=>{if(k.id===x.id)return r;return k});if(h.length)return[...h,r];return[r]})}function D1(x,d){var h,p;let i=x.getAllLeafColumnsById(),v=(r)=>{return P(d,r).filter((k)=>{let N=i[k.id];if(N){if(Ed(x1(N),k.value,N))return!1}return!0})};(h=(p=x.options).onColumnFiltersChange)===null||h===void 0||h.call(p,v)}function Jd(x,d){D1(x,d?[]:D(x.initialState.columnFilters??[]))}function Ed(x,d,h){return(x&&x.autoRemove?x.autoRemove(d,h):!1)||typeof d>"u"||typeof d==="string"&&!d}var Q0={getInitialState:(x)=>{return{columnFilters:Nd(),...x}},getDefaultColumnDef:()=>{return{filterFn:"auto"}},getDefaultTableOptions:(x)=>{return{onColumnFiltersChange:j1("columnFilters",x),filterFromLeafRows:!1,maxLeafRowFilterDepth:100}},assignColumnPrototype:(x,d)=>{H("columnFilteringFeature",x,d,{column_getAutoFilterFn:{fn:(h)=>q0(h)},column_getFilterFn:{fn:(h)=>x1(h)},column_getCanFilter:{fn:(h)=>Qd(h)},column_getIsFiltered:{fn:(h)=>Td(h)},column_getFilterValue:{fn:(h)=>Wd(h)},column_getFilterIndex:{fn:(h)=>N0(h)},column_setFilterValue:{fn:(h,p)=>Yd(h,p)}})},initRowInstanceData:(x)=>{x.columnFilters={},x.columnFiltersMeta={}},constructTableAPIs:(x)=>{L("columnFilteringFeature",x,{table_setColumnFilters:{fn:(d)=>D1(x,d)},table_resetColumnFilters:{fn:(d)=>Jd(x,d)}})}};function H1(x){var d,h;return(x.columnDef.enableGlobalFilter??!0)&&(x.table.options.enableGlobalFilter??!0)&&(x.table.options.enableFilters??!0)&&(((d=(h=x.table.options).getColumnCanGlobalFilter)===null||d===void 0?void 0:d.call(h,x))??!0)&&!!x.accessorFn}function T0(){return c1}function O1(x){let{globalFilterFn:d}=x.options,h=x._rowModelFns.filterFns;return M1(d)?d:d==="auto"?T0():h===null||h===void 0?void 0:h[d]}function W0(x,d){var h,p;(h=(p=x.options).onGlobalFilterChange)===null||h===void 0||h.call(p,d)}function Xd(x,d){W0(x,d?void 0:D(x.initialState.globalFilter))}var Y0={getInitialState:(x)=>{return{globalFilter:void 0,...x}},getDefaultTableOptions:(x)=>{return{onGlobalFilterChange:j1("globalFilter",x),globalFilterFn:"auto",getColumnCanGlobalFilter:(d)=>{var h;let p=(h=x.getCoreRowModel().flatRows[0])===null||h===void 0||(h=h.getAllCellsByColumnId()[d.id])===null||h===void 0?void 0:h.getValue();return typeof p==="string"||typeof p==="number"}}},assignColumnPrototype:(x,d)=>{H("globalFilteringFeature",x,d,{column_getCanGlobalFilter:{fn:(h)=>H1(h)}})},constructTableAPIs:(x)=>{L("globalFilteringFeature",x,{table_getGlobalAutoFilterFn:{fn:()=>T0()},table_getGlobalFilterFn:{fn:()=>O1(x)},table_setGlobalFilter:{fn:(d)=>W0(x,d)},table_resetGlobalFilter:{fn:(d)=>Xd(x,d)}})}};function Zd(x,d,h){if(h.options.filterFromLeafRows)return kh(x,d,h);return zh(x,d,h)}function kh(x,d,h){let p=[],i={},v=h.options.maxLeafRowFilterDepth??100,r=(k,N=0)=>{let q=[];for(let y of k){let z=q1(h,y.id,y.original,y.index,y.depth,void 0,y.parentId);if(z.columnFilters=y.columnFilters,y.subRows.length&&N<v){if(z.subRows=r(y.subRows,N+1),y=z,d(y)&&!z.subRows.length){q.push(y),i[y.id]=y,p.push(y);continue}if(d(y)||z.subRows.length){q.push(y),i[y.id]=y,p.push(y);continue}}else if(y=z,d(y))q.push(y),i[y.id]=y,p.push(y)}return q};return{rows:r(x),flatRows:p,rowsById:i}}function zh(x,d,h){let p=[],i={},v=h.options.maxLeafRowFilterDepth??100,r=(k,N=0)=>{let q=[];for(let y of k)if(d(y)){if(y.subRows.length&&N<v){let z=q1(h,y.id,y.original,y.index,y.depth,void 0,y.parentId);z.subRows=r(y.subRows,N+1),y=z}q.push(y),p.push(y),i[y.id]=y}return q};return{rows:r(x),flatRows:p,rowsById:i}}function J0(){return(x)=>{let d=x;return l({feature:"columnFilteringFeature",table:d,fnName:"table.getFilteredRowModel",memoDeps:()=>{var h,p;return[d.getPreFilteredRowModel(),(h=d.atoms.columnFilters)===null||h===void 0?void 0:h.get(),(p=d.atoms.globalFilter)===null||p===void 0?void 0:p.get()]},fn:()=>qh(d),onAfterUpdate:()=>A1(d)})}}function qh(x){var d,h;let p=x.getPreFilteredRowModel(),i=(d=x.atoms.columnFilters)===null||d===void 0?void 0:d.get(),v=(h=x.atoms.globalFilter)===null||h===void 0?void 0:h.get();if(!p.rows.length||!(i===null||i===void 0?void 0:i.length)&&!v){let Q=p.flatRows;for(let T=0;T<Q.length;T++){let J=Q[T];J.columnFilters={},J.columnFiltersMeta={}}return p}let r=[],k=[];i===null||i===void 0||i.forEach((Q)=>{var T;let J=L1(x,Q.id);if(!J)return;let Z=x1(J);r.push({id:Q.id,filterFn:Z,resolvedValue:((T=Z.resolveFilterValue)===null||T===void 0?void 0:T.call(Z,Q.value))??Q.value})});let N=(i===null||i===void 0?void 0:i.map((Q)=>Q.id))??[],q=O1(x),y=x.getAllLeafColumns().filter((Q)=>H1(Q));if(v&&q&&y.length)N.push("__global__"),y.forEach((Q)=>{var T;k.push({id:Q.id,filterFn:q,resolvedValue:((T=q.resolveFilterValue)===null||T===void 0?void 0:T.call(q,v))??v})});let z=p.flatRows;for(let Q=0;Q<z.length;Q++){let T=z[Q];if(T.columnFilters={},r.length)for(let J=0;J<r.length;J++){let Z=r[J],K=Z.id;T.columnFilters[K]=Z.filterFn(T,K,Z.resolvedValue,(E)=>{!T.columnFiltersMeta?T.columnFiltersMeta={}:T.columnFiltersMeta[K]=E})}if(k.length){for(let J=0;J<k.length;J++){let Z=k[J],K=Z.id;if(Z.filterFn(T,K,Z.resolvedValue,(E)=>{!T.columnFiltersMeta?T.columnFiltersMeta={}:T.columnFiltersMeta[K]=E})){T.columnFilters.__global__=!0;break}}if(T.columnFilters.__global__!==!0)T.columnFilters.__global__=!1}}let W=(Q)=>{for(let T=0;T<N.length;T++)if(Q.columnFilters[N[T]]===!1)return!1;return!0};return Zd(p.rows,W,x)}var E0=class{constructor(x){this._table=null,this._notifier=0,(this.host=x).addController(this)}table(x,d){if(!this._table){let i={...x,features:{coreReactivityFeature:e0(),...x.features},mergeOptions:(v,r)=>{return{...v,...r}}};this._table=r0(i),this._setupSubscriptions()}this._table.setOptions((i)=>({...i,...x}));let h=this._table,p=function(v){let r=(v.source??h.store).get(),k=v.selector!==void 0?v.selector(r):r;if(typeof v.children==="function")return v.children(k);return v.children};return{...this._table,Subscribe:p,FlexRender:_0,get state(){return(d===null||d===void 0?void 0:d(h.store.state))??h.store.state}}}_setupSubscriptions(){if(this._table&&!this._storeSubscription)this._storeSubscription=this._table.store.subscribe(()=>{this._notifier++,this.host.requestUpdate()}),this._optionsSubscription=this._table.optionsStore.subscribe(()=>{this._notifier++,this.host.requestUpdate()})}hostConnected(){this._setupSubscriptions()}hostDisconnected(){var x,d;(x=this._storeSubscription)===null||x===void 0||x.unsubscribe(),this._storeSubscription=void 0,(d=this._optionsSubscription)===null||d===void 0||d.unsubscribe(),this._optionsSubscription=void 0}};var Nh={sampleCount:0,cpuAverage:0,cpuPeak:0,memoryAverage:0,memoryPeak:0,memoryBytesPeak:0};function gd(x,d){let h=new Map;for(let p of x)h.set(Kd(p.kind,p.id),{...p,resources:{...p.resources},queuePosition:null,orderGroup:2});for(let p of d){let i=Kd(p.kind,p.id),v=h.get(i);h.set(i,{...v??Qh(p),status:p.status==="active"?"running":p.status,startedAt:p.leasedAt??v?.startedAt,queuePosition:p.position,orderGroup:p.status==="active"?0:1})}return[...h.values()].sort(Th)}function Qh(x){return{kind:x.kind,id:x.id,project:x.project,projectName:x.projectName,status:x.status,command:"",image:"",createdAt:x.acceptedAt,startedAt:x.leasedAt,finishedAt:void 0,exitCode:void 0,queueWaitMillis:void 0,resources:{...Nh}}}function Th(x,d){if(x.orderGroup!==d.orderGroup)return x.orderGroup-d.orderGroup;if(x.orderGroup<2)return(x.queuePosition??0)-(d.queuePosition??0);return Date.parse(d.createdAt)-Date.parse(x.createdAt)||d.id.localeCompare(x.id)}function Kd(x,d){return`${x}:${d}`}var Bd=d1`
  :host {
    --surface: #141417;
    --surface-hover: #1e1e23;
    --canvas-soft: #101013;
...
`;var Wh=v0({columnFilteringFeature:Q0,globalFilteringFeature:Y0,filteredRowModel:J0(),filterFns:z0}),Yh=[{id:"search",accessorFn:(x)=>[x.id,x.command,x.projectName,x.project,x.status,x.kind].join(" "),enableGlobalFilter:!0},{id:"status",accessorFn:(x)=>x.status,filterFn:"equalsString",enableGlobalFilter:!1},{id:"kind",accessorFn:(x)=>x.kind,filterFn:"equalsString",enableGlobalFilter:!1}],Jh={now:""};class Ud extends Z1(V){static styles=Bd;tableController=new E0(this);query="";statusFilter="";kindFilter="";rowsFingerprint="";rowsCache=[];render(){let x=this.signal("operations",[]),d=this.signal("queue",[]),h=this.signal("clock",Jh),p=this.rows(x,d),i=[...this.statusFilter?[{id:"status",value:this.statusFilter}]:[],...this.kindFilter?[{id:"kind",value:this.kindFilter}]:[]],r=this.tableController.table({features:Wh,columns:Yh,data:p,getCoreRowModel:N1(),globalFilterFn:"includesString",getColumnCanGlobalFilter:(N)=>N.id==="search",state:{globalFilter:this.query,columnFilters:i}}).getRowModel().rows.map((N)=>N.original),k=Date.parse(h.now);return X`
      <article class="runs-panel">
        <header class="runs-head">
          <div><strong>Runs</strong><span>${r.length===p.length?`${p.length} total`:`${r.length} of ${p.length}`}</span></div>
        ...
        ${r.length===0?this.empty(p.length>0):X`
    ...
    `}rows(x,d){let h=JSON.stringify([x,d]);if(h!==this.rowsFingerprint)this.rowsFingerprint=h,this.rowsCache=gd(x,d);return this.rowsCache}row(x,d){return X`<tr>
    ...
    </tr>`}empty(x){return X`<div class="empty"><strong>${x?"No matching runs":"No runs yet"}</strong><span>${x?"Try a different search or filter.":"Submit a repository command with autback exec."}</span></div>`}onSearch=(x)=>{this.query=x.currentTarget.value,this.requestUpdate()};onStatusFilter=(x)=>{this.statusFilter=x.currentTarget.value,this.requestUpdate()};onKindFilter=(x)=>{this.kindFilter=x.currentTarget.value,this.requestUpdate()}}function Eh(x,d){return`/app/runs/${encodeURIComponent(x)}/${encodeURIComponent(d)}`}function Xh(x){return x?x[0].toUpperCase()+x.slice(1):"—"}customElements.define("autback-runs-table",Ud);var Zh={samples:[],sampleCount:0,activeSampleCount:0,cpuCores:0,memoryTotalBytes:0,diskUsageBytes:0,diskTotalBytes:0,busyRatio:0,cpuAverage:0,cpuPeak:0,memoryAverage:0,memoryPeak:0,memoryBytesPeak:0,queueWaitP95Millis:0},O={session:{user:"",admin:!1,projects:[]},service:{name:"Autback",version:"",control:"CLI only",admission:"One at a time",startedAt:""},worker:{status:"connecting",capacity:"1 operation",activeId:"",updatedAt:""},clock:{now:""},resources:Zh,queue:[],operations:[],operation:null,log:{available:!1,truncated:!1,content:""},audit:[],status:{ready:!1,route:"",message:"Connecting",updatedAt:""}};class Md extends Z1(V){static styles=$0;get routeKind(){return this.getAttribute("route-kind")||"overview"}get project(){return this.getAttribute("project")||""}get operationID(){return this.getAttribute("operation-id")||""}render(){let x=this.signals();return X`<div class="shell">
      ${this.sidebar(x)}
      ...
      <div class="sidebar-foot"><div class="identity"><span class="avatar">${Uh(x.session.user)}</span><div>
        <div class="identity-name">${x.session.user||"Connecting"}</div><div class="identity-role">${x.session.admin?"Administrator":"Member"}</div>
      </div></div></div>
    </aside>`}navLink(x,d,h,p){return X`<a class="nav-link ${this.routeKind===d?"active":""}" href=${x}>${c(p)}<span>${h}</span></a>`}topbar(x){let d=this.routeKind==="project"?this.project:this.routeKind==="operation"?R(this.operationID,18):this.routeKind==="audit"?"Audit log":"Runs";return X`<header class="topbar">
    ...
    `}projectPage(x){let d=x.session.projects.find((h)=>h.slug===this.project);if(!d)return this.notFound("You do not have access to this project.");return X`
      ...
      <autback-runs-table></autback-runs-table>
    `}runPage(x,d){let h=x.operation;if(!h)return this.notFound("You do not have access to this run.");let p=h.command||`${V1(h.kind)} ${R(h.id,18)}`;return X`
      ${this.pageHead(`${V1(h.kind)} run`,p,`${h.projectName} · ${R(h.id,26)}`)}
      ${this.resourceChart(x.resources,"Resource utilization")}
    ...
    `}resourceMetrics(x){return X`<section class="metrics" aria-label="Runner capacity summary">
    ...
    </section>`}resourceChart(x,d){let h=nd(x.samples,(r)=>r.cpuUtilization),p=nd(x.samples,(r)=>r.memoryUtilization),i=x.samples.at(0),v=x.samples.at(-1);return X`<article class="panel resource-panel">
      ...
      ${x.samples.length<2?Q1("activity","Collecting runner data","Utilization will appear after the next samples arrive."):X`
        ...
        <div class="resource-chart">
          <svg viewBox="0 0 900 230" preserveAspectRatio="none" role="img" aria-label="CPU and memory utilization over time">
            ${[0,0.25,0.5,0.75,1].map((r)=>n`<line class="grid-line" x1="42" y1=${f1(r)} x2="892" y2=${f1(r)}></line><text class="axis-label" x="4" y=${f1(r)+4}>${Math.round(r*100)}%</text>`)}
            <polyline class="series memory" points=${p}></polyline>
            <polyline class="series cpu" points=${h}></polyline>
          </svg>
          <div class="chart-times"><span>${jd(i?.observedAt)}</span><span>${jd(v?.observedAt)}</span></div>
        </div>
      `}
      ...
      <article class="panel project-health"><div><span>Success rate</span><strong>${m0(x.map((i)=>i.status))}</strong></div><div><span>Queue wait p95</span><strong>${e(gh(x.map((i)=>i.queueWaitMillis)))}</strong></div></article>
      ...
      ${x.log.available?X`<pre class="log">${x.log.content||"Waiting for output…"}</pre>${x.log.truncated?X`<div class="log-note">${h?X`Following live output. ${p}`:p}</div>`:g}`:Q1("terminal","No output available",d.kind==="build"?"Build progress remains in the invoking terminal.":"The runner has not produced output yet.")}
      ...
      <tbody>${x.map((h)=>X`<tr><td><span class="audit-action">${h.action}</span>${Bh(h)}</td><td>${h.actor}</td><td>${h.project||"Service"}</td><td class="mono">${R(h.target,18)}</td><td>${z1(h.createdAt,d)}</td></tr>`)}</tbody>
    </table></div>`}pageHead(x,d,h){return X`<header class="page-head"><div><p class="eyebrow">${x}</p><h1>${d}</h1><p class="lede">${h}</p></div><div class="read-only">${c("eye")}CLI-managed</div></header>`}notFound(x){return X`${this.pageHead("Not found","Unavailable",x)}<article class="panel">${Q1("shield","Nothing to show","Return to the console overview.")}</article>`}}function c(x){let d={activity:n`<path d="M3 12h4l2.2-6 4.2 12 2.2-6H21"/>`,clock:n`<circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2"/>`,cpu:n`<rect x="7" y="7" width="10" height="10" rx="2"/><path d="M9 1v3M15 1v3M9 20v3M15 20v3M20 9h3M20 14h3M1 9h3M1 14h3"/>`,cube:n`<path d="m12 3 8 4.5v9L12 21l-8-4.5v-9Z"/><path d="m4.5 7.8 7.5 4.3 7.5-4.3M12 12v9"/>`,disk:n`<ellipse cx="12" cy="5" rx="8" ry="3"/><path d="M4 5v7c0 1.7 3.6 3 8 3s8-1.3 8-3V5M4 12v7c0 1.7 3.6 3 8 3s8-1.3 8-3v-7"/>`,eye:n`<path d="M2 12s3.6-6 10-6 10 6 10 6-3.6 6-10 6S2 12 2 12Z"/><circle cx="12" cy="12" r="2.5"/>`,fingerprint:n`<path d="M8 11a4 4 0 0 1 8 0c0 5-1 8-3 10M5 11a7 7 0 0 1 14 0c0 4-.5 7-2 10M11 14c0 3-.5 5-1.5 7M8 15c0 2-.4 3.5-1 5M12 2a9 9 0 0 0-9 9"/>`,memory:n`<rect x="5" y="7" width="14" height="10" rx="2"/><path d="M8 3v4M12 3v4M16 3v4M8 17v4M12 17v4M16 17v4M9 11h6"/>`,pulse:n`<path d="M3 12h4l2-5 4 10 2-5h6"/>`,queue:n`<path d="M9 6h12M9 12h12M9 18h12"/><circle cx="4" cy="6" r="1"/><circle cx="4" cy="12" r="1"/><circle cx="4" cy="18" r="1"/>`,shield:n`<path d="M12 3 20 6v6c0 5-3.4 8-8 10-4.6-2-8-5-8-10V6Z"/><path d="m9 12 2 2 4-5"/>`,terminal:n`<rect x="3" y="4" width="18" height="16" rx="2"/><path d="m7 9 3 3-3 3M13 15h4"/>`,trend:n`<path d="m3 17 6-6 4 4 8-9"/><path d="M15 6h6v6"/>`};return n`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${d[x]}</svg>`}function F(x,d,h,p){return X`<article class="metric"><div class="metric-top"><span>${x}</span>${c(p)}</div><div class="metric-value">${V1(d)}</div><div class="metric-note">${h}</div></article>`}function Q1(x,d,h){return X`<div class="empty"><div>${c(x)}<strong>${d}</strong><span>${h}</span></div></div>`}function Kh(x){return x.cpuCores?`${x.cpuCores} vCPU · ${o(x.memoryTotalBytes)} · ${o(x.diskTotalBytes)} disk`:"Waiting for capacity data"}function f1(x){return 216-Math.max(0,Math.min(1,x))*196}function nd(x,d){if(x.length===0)return"";return x.map((h,p)=>`${42+p/Math.max(1,x.length-1)*850},${f1(d(h))}`).join(" ")}function jd(x){if(!x)return"—";return new Intl.DateTimeFormat(void 0,{hour:"2-digit",minute:"2-digit"}).format(new Date(x))}function gh(x){let d=x.filter((h)=>h!=null&&Number.isFinite(h)).sort((h,p)=>h-p);return d.length?d[Math.ceil(d.length*0.95)-1]:void 0}function Bh(x){let d=Object.entries(x.metadata??{}).slice(0,3);return d.length===0?g:X`<div class="metadata">${d.map(([h,p])=>X`<span>${h}=${R(p,28)}</span>`)}</div>`}function V1(x){return x?x[0].toUpperCase()+x.slice(1):"—"}function Uh(x){return x.split(/\s+/).filter(Boolean).slice(0,2).map((d)=>d[0]?.toUpperCase()).join("")||"A"}customElements.define("autback-console",Md);
